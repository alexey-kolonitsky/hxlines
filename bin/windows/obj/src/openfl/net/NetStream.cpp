...
HXLINE( 210)		this->_hx___playStatus(HX_("NetStream.Play.canplay",1b,cc,cb,cb));
            	}
...
HXLINE( 217)		this->_hx___playStatus(HX_("NetStream.Play.canplaythrough",8a,05,15,a9));
            	}
...
HXLINE( 224)		this->_hx___playStatus(HX_("NetStream.Play.durationchanged",37,45,91,e1));
            	}
...
HXLINE( 271)		this->_hx___playStatus(HX_("NetStream.Play.loadstart",53,26,16,e6));
            	}
...
HXLINE( 278)		this->_hx___playStatus(HX_("NetStream.Play.pause",4d,35,75,82));
            	}
...
HXLINE( 293)		this->_hx___playStatus(HX_("NetStream.Play.seeking",81,24,a5,cc));
            	}
...
HXLINE( 300)		this->_hx___playStatus(HX_("NetStream.Play.stalled",96,b1,10,7f));
            	}
...
HXLINE( 311)		this->_hx___playStatus(HX_("NetStream.Play.timeupdate",1f,a0,f4,d6));
            	}
...
HXLINE( 318)		this->_hx___playStatus(HX_("NetStream.Play.waiting",a4,cb,1a,2d));
            	}
...
hx::Val NetStream_obj::__SetField(const ::String &inName,const hx::Val &inValue,hx::PropertyAccess inCallProp)
{
	...
	case 4:
		...
		break;
	case 5:
		if (HX_FIELD_EQ(inName,"speed") ) { if (inCallProp == hx::paccAlways) return hx::Val( set_speed(inValue) ); }
		break;
	case 6:
