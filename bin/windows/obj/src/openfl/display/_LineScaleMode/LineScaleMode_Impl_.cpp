...
HXLINE(  27)		switch((int)(value)){
            			case (int)0: {
HXLINE(  27)				return HX_("horizontal",e4,fc,c3,15);
            			}
            			break;
            			case (int)1: {
HXLINE(  27)				return HX_("none",b8,12,0a,49);
            			...
            			break;
            			case (int)2: {
HXLINE(  27)				return HX_("normal",27,72,69,30);
            			}
            			break;
            			case (int)3: {
HXLINE(  27)				return HX_("vertical",76,bc,15,6a);
            			}
            			break;
            			default:{
