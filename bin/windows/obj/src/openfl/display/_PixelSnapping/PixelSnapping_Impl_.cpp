...
HXLINE(  25)		switch((int)(value)){
            			case (int)0: {
HXLINE(  25)				return HX_("always",cf,0e,d7,46);
            			}
            			break;
            			case (int)1: {
HXLINE(  25)				return HX_("auto",6f,df,76,40);
            			}
            			break;
            			case (int)2: {
HXLINE(  25)				return HX_("never",8c,3e,30,99);
            			}
            			break;
            			default:{
