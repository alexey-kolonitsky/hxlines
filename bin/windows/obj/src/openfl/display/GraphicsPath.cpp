...
HXLINE( 111)		this->_hx___drawRoundRect((x - radius),(y - radius),(radius * (int)2),(radius * (int)2),(radius * (int)2),(radius * (int)2));
            	}
...
HXLINE( 118)		this->_hx___drawRoundRect(x,y,width,height,width,height);
            	}
...
HXLINE(  11)		SIN45 = ((Float)0.70710678118654752440084436210485);
            	}
{
            	HX_STACKFRAME(&_hx_pos_9d2387a0b056a42f_12_boot)
HXLINE(  12)		TAN22 = ((Float)0.4142135623730950488016887242097);
            	}
}
