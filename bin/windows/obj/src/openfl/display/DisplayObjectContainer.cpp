...
HXLINE( 894)		if (!(this->_hx___transformDirty)) {
...
HXLINE( 915)		int _g = (int)0;
HXDLIN( 915)		::Array< ::Dynamic> _g1 = this->_hx___children;
HXDLIN( 915)		while((_g < _g1->length)){
HXLINE( 915)			 ::openfl::display::DisplayObject child = _g1->__get(_g).StaticCast<  ::openfl::display::DisplayObject >();
...
HXLINE( 963)		return this->_hx___children->length;
            	}
