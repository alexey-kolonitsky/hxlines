...
HXLINE(  85)		return this->_hx___tabEnabled;
            	}
...
HXLINE(  92)		return (this->_hx___tabEnabled = value);
            	}
...
hx::Val InteractiveObject_obj::__SetField(const ::String &inName,const hx::Val &inValue,hx::PropertyAccess inCallProp)
{
	...
	case 9:
		...
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"tabEnabled") ) { if (inCallProp == hx::paccAlways) return hx::Val( set_tabEnabled(inValue) ); }
		break;
	case 12:
