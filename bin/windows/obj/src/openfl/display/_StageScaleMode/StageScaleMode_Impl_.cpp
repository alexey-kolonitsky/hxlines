...
HXLINE(  27)		switch((int)(value)){
            			case (int)0: {
HXLINE(  27)				return HX_("exactFit",52,58,22,25);
            			}
            			break;
            			case (int)1: {
HXLINE(  27)				return HX_("noBorder",0d,48,2a,34);
            			}
            			break;
            			case (int)2: {
HXLINE(  27)				return HX_("noScale",89,52,d2,4b);
            			}
            			break;
            			case (int)3: {
HXLINE(  27)				return HX_("showAll",24,58,96,7b);
            			}
            			break;
            			default:{
