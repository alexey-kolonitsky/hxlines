...
HXLINE(  25)		switch((int)(value)){
            			case (int)0: {
HXLINE(  25)				return HX_("pad",53,51,55,00);
            			}
            			break;
            			case (int)1: {
HXLINE(  25)				return HX_("reflect",3d,84,29,e9);
            			}
            			break;
            			case (int)2: {
HXLINE(  25)				return HX_("repeat",5b,97,7c,06);
            			}
            			break;
            			default:{
