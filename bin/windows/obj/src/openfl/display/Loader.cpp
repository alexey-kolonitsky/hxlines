...
HXLINE(  59)		::openfl::Lib_obj::notImplemented(hx::SourceInfo(HX_("Loader.hx",6b,e8,d2,9c),59,HX_("openfl.display.Loader",fd,67,b0,e2),HX_("close",b8,17,63,48)));
            	}
...
HXLINE( 157)		::openfl::display::BitmapData_obj::loadFromBytes(buffer,null())->onComplete(this->BitmapData_onLoad_dyn())->onError(this->BitmapData_onError_dyn());
            	}
...
HXLINE( 164)		if (!(this->_hx___unloaded)) {
...
HXLINE( 212)		if (gc) {
HXLINE( 215)			::cpp::vm::Gc_obj::run(false);
            		}
            	}
...
HXLINE( 245)		this->_hx___dispatchError(::Std_obj::string(error));
            	}
...
HXLINE( 273)		 ::openfl::display::Loader _gthis = hx::ObjectPtr<OBJ_>(this);
