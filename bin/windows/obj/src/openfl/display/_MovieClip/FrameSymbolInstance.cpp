...
HX_DEFINE_STACK_FRAME(_hx_pos_e7c49b2409073623_859_new,"openfl.display._MovieClip.FrameSymbolInstance","new",0xd335e789,"openfl.display._MovieClip.FrameSymbolInstance.new","openfl/display/MovieClip.hx",859,0x2b84738a)
namespace openfl{
namespace display{
...
void FrameSymbolInstance_obj::__construct(int initFrame,int initFrameObjectID,int characterID,int depth, ::openfl::display::DisplayObject displayObject,int clipDepth){
            	HX_STACKFRAME(&_hx_pos_e7c49b2409073623_859_new)
HXLINE( 861)		this->initFrame = initFrame;
HXLINE( 862)		this->initFrameObjectID = initFrameObjectID;
HXLINE( 863)		this->characterID = characterID;
HXLINE( 864)		this->depth = depth;
HXLINE( 865)		this->displayObject = displayObject;
HXLINE( 866)		this->clipDepth = clipDepth;
            	}
