...
HXLINE(  27)		switch((int)(value)){
            			case (int)0: {
HXLINE(  27)				return HX_("best",24,f1,13,41);
            			}
            			break;
            			case (int)1: {
HXLINE(  27)				return HX_("high",62,37,0e,45);
            			}
            			break;
            			case (int)2: {
HXLINE(  27)				return HX_("low",94,54,52,00);
            			}
            			break;
            			case (int)3: {
HXLINE(  27)				return HX_("medium",75,54,c8,fe);
            			}
            			break;
            			default:{
