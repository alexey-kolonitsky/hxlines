...
HXLINE( 184)		return  ::Dynamic(::openfl::Lib_obj::current->stage->window->config->__Field(HX_("background",ee,93,1d,26),hx::paccDynamic));
            	}
...
HXLINE( 225)		this->addEventListener(HX_("enterFrame",f5,03,50,02),this->this_onEnterFrame_dyn(),null(),null(),null());
            	}
...
HXLINE( 310)		int _hx_tmp = ::Std_obj::_hx_int(event->bytesLoaded);
