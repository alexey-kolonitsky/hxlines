...
HXLINE( 118)			_hx_tmp6 = (this->redMultiplier == ct->redMultiplier);
            		}
            		else {
HXLINE( 118)			_hx_tmp6 = false;
            		}
HXDLIN( 118)		if (_hx_tmp6) {
HXLINE( 118)			_hx_tmp5 = (this->greenMultiplier == ct->greenMultiplier);
            		}
            		else {
HXLINE( 118)			_hx_tmp5 = false;
            		}
HXDLIN( 118)		if (_hx_tmp5) {
HXLINE( 118)			_hx_tmp4 = (this->blueMultiplier == ct->blueMultiplier);
            		}
            		else {
HXLINE( 118)			_hx_tmp4 = false;
            		}
HXDLIN( 118)		if (_hx_tmp4) {
HXLINE( 118)			if (!(skipAlphaMultiplier)) {
HXLINE( 118)				_hx_tmp3 = (this->alphaMultiplier == ct->alphaMultiplier);
            			}
            			else {
...
HXLINE( 118)			_hx_tmp2 = (this->redOffset == ct->redOffset);
            		}
            		else {
HXLINE( 118)			_hx_tmp2 = false;
            		}
HXDLIN( 118)		if (_hx_tmp2) {
HXLINE( 118)			_hx_tmp1 = (this->greenOffset == ct->greenOffset);
            		}
            		else {
HXLINE( 118)			_hx_tmp1 = false;
            		}
HXDLIN( 118)		if (_hx_tmp1) {
HXLINE( 118)			_hx_tmp = (this->blueOffset == ct->blueOffset);
            		}
            		else {
HXLINE( 118)			_hx_tmp = false;
            		}
HXDLIN( 118)		if (_hx_tmp) {
HXLINE( 118)			return (this->alphaOffset == ct->alphaOffset);
            		}
            		else {
...
HXLINE( 125)			_hx_tmp5 = (this->greenMultiplier == (int)1);
            		}
            		else {
HXLINE( 125)			_hx_tmp5 = false;
            		}
HXDLIN( 125)		if (_hx_tmp5) {
HXLINE( 125)			_hx_tmp4 = (this->blueMultiplier == (int)1);
            		}
            		else {
HXLINE( 125)			_hx_tmp4 = false;
            		}
HXDLIN( 125)		if (_hx_tmp4) {
HXLINE( 125)			_hx_tmp3 = (this->alphaMultiplier == (int)1);
            		}
            		else {
HXLINE( 125)			_hx_tmp3 = false;
            		}
HXDLIN( 125)		if (_hx_tmp3) {
HXLINE( 125)			_hx_tmp2 = (this->redOffset == (int)0);
            		}
            		else {
HXLINE( 125)			_hx_tmp2 = false;
            		}
HXDLIN( 125)		if (_hx_tmp2) {
HXLINE( 125)			_hx_tmp1 = (this->greenOffset == (int)0);
            		}
            		else {
HXLINE( 125)			_hx_tmp1 = false;
            		}
HXDLIN( 125)		if (_hx_tmp1) {
HXLINE( 125)			_hx_tmp = (this->blueOffset == (int)0);
            		}
            		else {
HXLINE( 125)			_hx_tmp = false;
            		}
HXDLIN( 125)		if (_hx_tmp) {
HXLINE( 125)			return (this->alphaOffset == (int)0);
            		}
            		else {
...
HXLINE( 139)		int _hx_tmp = ((int)::Std_obj::_hx_int(this->redOffset) << (int)(int)16);
