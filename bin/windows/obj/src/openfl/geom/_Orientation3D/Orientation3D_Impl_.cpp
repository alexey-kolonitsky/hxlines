...
HXLINE(  25)		switch((int)(value)){
            			case (int)0: {
HXLINE(  25)				return HX_("axisAngle",72,2f,86,7c);
            			}
            			break;
            			case (int)1: {
HXLINE(  25)				return HX_("eulerAngles",89,d7,c4,64);
            			}
            			break;
            			case (int)2: {
HXLINE(  25)				return HX_("quaternion",1e,0d,ca,1b);
            			}
            			break;
            			default:{
