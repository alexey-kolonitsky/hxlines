...
HXDLIN( 299)		if ((this->index < this->list->length)) {
HXLINE( 299)			_hx_tmp = !(this->isCopy);
            		}
            		else {
...
HXLINE( 311)		if ((this->index < this->list->length)) {
...
HXLINE( 327)		::Array< ::Dynamic> _hx_tmp = this->list;
