...
HXLINE(  30)		return this->_hx___formatToString(HX_("SecurityErrorEvent",32,ea,b2,a1),::Array_obj< ::String >::fromData( _hx_array_data_072c9809_3,5));
            	}
...
HXLINE(   7)		SECURITY_ERROR = HX_("securityError",e8,28,7c,a2);
            	}
}
