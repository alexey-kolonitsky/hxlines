...
HXLINE( 109)		return this->_hx___formatToString(HX_("MouseEvent",d5,bf,42,8a),::Array_obj< ::String >::fromData( _hx_array_data_094f3eac_3,11));
            	}
...
HXLINE(  11)		CLICK = HX_("click",48,7c,5e,48);
            	}
{
            	HX_STACKFRAME(&_hx_pos_93a9f8214e96e0e7_12_boot)
HXLINE(  12)		DOUBLE_CLICK = HX_("doubleClick",77,03,76,cd);
            	}
{
