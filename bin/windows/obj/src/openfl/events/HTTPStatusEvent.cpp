...
HXLINE(  42)		return this->_hx___formatToString(HX_("HTTPStatusEvent",e0,4c,1b,fe),::Array_obj< ::String >::fromData( _hx_array_data_61c0a2a9_3,5));
            	}
...
HXLINE(  10)		HTTP_RESPONSE_STATUS = HX_("httpResponseStatus",3b,ae,f6,61);
            	}
{
            	HX_STACKFRAME(&_hx_pos_3e9f49414be9df9e_11_boot)
HXLINE(  11)		HTTP_STATUS = HX_("httpStatus",da,4c,74,0a);
            	}
}
