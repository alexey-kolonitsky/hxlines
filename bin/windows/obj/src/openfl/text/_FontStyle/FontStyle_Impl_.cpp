...
HXLINE(  27)		switch((int)(value)){
            			case (int)0: {
HXLINE(  27)				return HX_("bold",85,81,1b,41);
            			}
            			break;
            			case (int)1: {
HXLINE(  27)				return HX_("boldItalic",55,96,d1,ad);
            			}
            			break;
            			case (int)2: {
HXLINE(  27)				return HX_("italic",f0,2e,64,06);
            			}
            			break;
            			case (int)3: {
HXLINE(  27)				return HX_("regular",5c,52,88,82);
            			}
            			break;
            			default:{
