...
HXLINE(  31)		switch((int)(value)){
            			case (int)0: {
HXLINE(  31)				return HX_("center",d5,25,db,05);
            			}
            			break;
            			case (int)1: {
HXLINE(  31)				return HX_("end",db,03,4d,00);
            			}
            			break;
            			case (int)2: {
HXLINE(  31)				return HX_("justify",50,df,b5,83);
            			}
            			break;
            			case (int)3: {
HXLINE(  31)				return HX_("left",07,08,b0,47);
            			}
            			break;
            			case (int)4: {
HXLINE(  31)				return HX_("right",dc,0b,64,e9);
            			}
            			break;
            			case (int)5: {
HXLINE(  31)				return HX_("start",62,74,0b,84);
            			}
            			break;
            			default:{
