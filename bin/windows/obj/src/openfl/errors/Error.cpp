...
HXLINE(  33)		return ::haxe::CallStack_obj::toString(::haxe::CallStack_obj::exceptionStack());
            	}
...
HXLINE(  40)		if (hx::IsNotNull( this->message )) {
...
HXLINE(  15)		DEFAULT_TO_STRING = HX_("Error",a8,3b,57,06);
            	}
}
