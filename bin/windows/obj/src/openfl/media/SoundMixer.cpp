...
HXLINE(  28)			 ::openfl::media::SoundChannel channel = _g1->__get(_g).StaticCast<  ::openfl::media::SoundChannel >();
...
HXLINE(  39)		::openfl::media::SoundMixer_obj::_hx___soundChannels->push(soundChannel);
            	}
...
HXLINE(  46)		::openfl::media::SoundMixer_obj::_hx___soundChannels->remove(soundChannel);
            	}
...
HXLINE(  60)		return ::openfl::media::SoundMixer_obj::_hx___soundTransform;
            	}
...
HXLINE(  10)		MAX_ACTIVE_CHANNELS = (int)32;
            	}
{
            	HX_STACKFRAME(&_hx_pos_1587d256662a54fa_15_boot)
HXLINE(  15)		_hx___soundChannels = ::Array_obj< ::Dynamic>::__new();
            	}
{
            	HX_GC_STACKFRAME(&_hx_pos_1587d256662a54fa_16_boot)
HXLINE(  16)		_hx___soundTransform =  ::openfl::media::SoundTransform_obj::__alloc( HX_CTX ,null(),null());
            	}
}
