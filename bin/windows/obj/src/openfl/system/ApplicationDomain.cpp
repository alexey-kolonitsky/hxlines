...
HXLINE(  17)		if (hx::IsNotNull( parentDomain )) {
...
HXLINE(  32)		return ::Type_obj::resolveClass(name);
            	}
...
HXLINE(  39)		return hx::IsNotNull( ::Type_obj::resolveClass(name) );
            	}
...
HXLINE(  10)		currentDomain =  ::openfl::_hx_system::ApplicationDomain_obj::__alloc( HX_CTX ,null());
            	}
}
