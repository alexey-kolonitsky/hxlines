...
HXLINE( 273)		 ::openfl::_internal::renderer::DrawCommandReader this1 = d;
...
HXLINE( 274)		return this1->buffer->f->__get(this1->fPos);
            	}
...
HXLINE( 275)		::Array< Float > this2 = this1->buffer->f;
...
HXLINE( 276)		::Array< Float > this2 = this1->buffer->f;
...
HXLINE( 277)		::Array< Float > this2 = this1->buffer->f;
...
HXLINE( 278)		::Array< Float > this2 = this1->buffer->f;
...
HXLINE( 279)		::Array< Float > this2 = this1->buffer->f;
