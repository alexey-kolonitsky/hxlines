...
HXLINE( 410)		 ::openfl::_internal::renderer::DrawCommandReader this1 = d;
...
HXLINE( 411)		return this1->buffer->f->__get(this1->fPos);
            	}
...
HXLINE( 412)		::Array< Float > this2 = this1->buffer->f;
