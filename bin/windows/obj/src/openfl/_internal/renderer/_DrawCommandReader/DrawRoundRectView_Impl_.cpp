...
HXLINE( 329)		 ::openfl::_internal::renderer::DrawCommandReader this1 = d;
...
HXLINE( 330)		return this1->buffer->f->__get(this1->fPos);
            	}
...
HXLINE( 331)		::Array< Float > this2 = this1->buffer->f;
...
HXLINE( 332)		::Array< Float > this2 = this1->buffer->f;
...
HXLINE( 333)		::Array< Float > this2 = this1->buffer->f;
...
HXLINE( 334)		::Array< Float > this2 = this1->buffer->f;
...
HXLINE( 335)		return this1->buffer->o->__get(this1->oPos);
            	}
