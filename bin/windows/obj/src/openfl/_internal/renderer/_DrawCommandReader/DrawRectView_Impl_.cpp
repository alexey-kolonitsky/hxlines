...
HXLINE( 318)		 ::openfl::_internal::renderer::DrawCommandReader this1 = d;
...
HXLINE( 319)		return this1->buffer->f->__get(this1->fPos);
            	}
...
HXLINE( 320)		::Array< Float > this2 = this1->buffer->f;
...
HXLINE( 321)		::Array< Float > this2 = this1->buffer->f;
...
HXLINE( 322)		::Array< Float > this2 = this1->buffer->f;
