...
HXLINE( 249)		 ::openfl::_internal::renderer::DrawCommandReader this1 = d;
...
HXLINE( 250)		return this1->buffer->i->__get(this1->iPos);
            	}
...
HXLINE( 251)		return this1->buffer->f->__get(this1->fPos);
            	}
