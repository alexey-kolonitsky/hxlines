...
HXLINE( 238)		 ::openfl::_internal::renderer::DrawCommandReader this1 = d;
...
HXLINE( 239)		return ( ( ::openfl::display::BitmapData)(this1->buffer->o->__get(this1->oPos)) );
            	}
...
HXLINE( 240)		::cpp::VirtualArray this2 = this1->buffer->o;
...
HXLINE( 241)		return this1->buffer->b->__get(this1->bPos);
            	}
...
HXLINE( 242)		::Array< bool > this2 = this1->buffer->b;
