...
HXLINE( 258)		 ::openfl::_internal::renderer::DrawCommandReader this1 = d;
...
HXLINE( 259)		return this1->buffer->o->__get(this1->oPos);
            	}
...
HXLINE( 260)		return this1->buffer->ii->__get(this1->iiPos).StaticCast< ::Array< int > >();
            	}
...
HXLINE( 261)		return this1->buffer->ff->__get(this1->ffPos).StaticCast< ::Array< Float > >();
            	}
...
HXLINE( 262)		::Array< ::Dynamic> this2 = this1->buffer->ii;
...
HXLINE( 263)		::cpp::VirtualArray this2 = this1->buffer->o;
...
HXLINE( 264)		::cpp::VirtualArray this2 = this1->buffer->o;
...
HXLINE( 265)		::cpp::VirtualArray this2 = this1->buffer->o;
...
HXLINE( 266)		return this1->buffer->f->__get(this1->fPos);
            	}
