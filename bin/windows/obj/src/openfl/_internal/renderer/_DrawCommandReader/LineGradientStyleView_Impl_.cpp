...
HXLINE( 371)		 ::openfl::_internal::renderer::DrawCommandReader this1 = d;
...
HXLINE( 372)		return this1->buffer->o->__get(this1->oPos);
            	}
...
HXLINE( 373)		return this1->buffer->ii->__get(this1->iiPos).StaticCast< ::Array< int > >();
            	}
...
HXLINE( 374)		return this1->buffer->ff->__get(this1->ffPos).StaticCast< ::Array< Float > >();
            	}
...
HXLINE( 375)		::Array< ::Dynamic> this2 = this1->buffer->ii;
...
HXLINE( 376)		::cpp::VirtualArray this2 = this1->buffer->o;
...
HXLINE( 377)		::cpp::VirtualArray this2 = this1->buffer->o;
...
HXLINE( 378)		::cpp::VirtualArray this2 = this1->buffer->o;
