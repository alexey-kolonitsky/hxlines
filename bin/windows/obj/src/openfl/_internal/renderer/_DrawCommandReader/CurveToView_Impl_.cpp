...
HXLINE( 286)		 ::openfl::_internal::renderer::DrawCommandReader this1 = d;
...
HXLINE( 287)		return this1->buffer->f->__get(this1->fPos);
            	}
...
HXLINE( 288)		::Array< Float > this2 = this1->buffer->f;
...
HXLINE( 289)		::Array< Float > this2 = this1->buffer->f;
...
HXLINE( 290)		::Array< Float > this2 = this1->buffer->f;
