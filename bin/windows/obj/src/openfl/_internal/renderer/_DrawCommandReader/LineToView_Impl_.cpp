...
HXLINE( 401)		 ::openfl::_internal::renderer::DrawCommandReader this1 = d;
...
HXLINE( 402)		return this1->buffer->f->__get(this1->fPos);
            	}
...
HXLINE( 403)		::Array< Float > this2 = this1->buffer->f;
