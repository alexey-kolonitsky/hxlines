...
HX_LOCAL_STACK_FRAME(_hx_pos_ca7a636da47018f2_495_hitTest,"openfl._internal.renderer.canvas.CanvasGraphics","hitTest",0xf1176f55,"openfl._internal.renderer.canvas.CanvasGraphics.hitTest","openfl/_internal/renderer/canvas/CanvasGraphics.hx",495,0x0b9ff65e)
HX_LOCAL_STACK_FRAME(_hx_pos_ca7a636da47018f2_502_isCCW,"openfl._internal.renderer.canvas.CanvasGraphics","isCCW",0xce74af1d,"openfl._internal.renderer.canvas.CanvasGraphics.isCCW","openfl/_internal/renderer/canvas/CanvasGraphics.hx",502,0x0b9ff65e)
HX_LOCAL_STACK_FRAME(_hx_pos_ca7a636da47018f2_507_normalizeUVT,"openfl._internal.renderer.canvas.CanvasGraphics","normalizeUVT",0x11b66056,"openfl._internal.renderer.canvas.CanvasGraphics.normalizeUVT","openfl/_internal/renderer/canvas/CanvasGraphics.hx",507,0x0b9ff65e)
HX_LOCAL_STACK_FRAME(_hx_pos_ca7a636da47018f2_556_playCommands,"openfl._internal.renderer.canvas.CanvasGraphics","playCommands",0x147605cc,"openfl._internal.renderer.canvas.CanvasGraphics.playCommands","openfl/_internal/renderer/canvas/CanvasGraphics.hx",556,0x0b9ff65e)
HX_LOCAL_STACK_FRAME(_hx_pos_ca7a636da47018f2_922_render,"openfl._internal.renderer.canvas.CanvasGraphics","render",0x7dc3ee46,"openfl._internal.renderer.canvas.CanvasGraphics.render","openfl/_internal/renderer/canvas/CanvasGraphics.hx",922,0x0b9ff65e)
HX_LOCAL_STACK_FRAME(_hx_pos_ca7a636da47018f2_1421_renderMask,"openfl._internal.renderer.canvas.CanvasGraphics","renderMask",0xfa8ef652,"openfl._internal.renderer.canvas.CanvasGraphics.renderMask","openfl/_internal/renderer/canvas/CanvasGraphics.hx",1421,0x0b9ff65e)
HX_LOCAL_STACK_FRAME(_hx_pos_ca7a636da47018f2_1529_setSmoothing,"openfl._internal.renderer.canvas.CanvasGraphics","setSmoothing",0x84b8ec62,"openfl._internal.renderer.canvas.CanvasGraphics.setSmoothing","openfl/_internal/renderer/canvas/CanvasGraphics.hx",1529,0x0b9ff65e)
...
bool CanvasGraphics_obj::hitTest( ::openfl::display::Graphics graphics,Float x,Float y){
            	HX_STACKFRAME(&_hx_pos_ca7a636da47018f2_495_hitTest)
...
bool CanvasGraphics_obj::isCCW(Float x1,Float y1,Float x2,Float y2,Float x3,Float y3){
            	HX_STACKFRAME(&_hx_pos_ca7a636da47018f2_502_isCCW)
HXLINE( 502)		return ((((x2 - x1) * (y3 - y1)) - ((y2 - y1) * (x3 - x1))) < (int)0);
            	}
...
bool skipT = __o_skipT.Default(false);
            	HX_GC_STACKFRAME(&_hx_pos_ca7a636da47018f2_507_normalizeUVT)
HXLINE( 509)		Float max = ::Math_obj::NEGATIVE_INFINITY;
HXLINE( 510)		Float tmp = ::Math_obj::NEGATIVE_INFINITY;
HXLINE( 511)		int len = uvt->get_length();
HXLINE( 513)		{
HXLINE( 513)			int _g1 = (int)1;
HXDLIN( 513)			int _g = (len + (int)1);
HXDLIN( 513)			while((_g1 < _g)){
HXLINE( 513)				_g1 = (_g1 + (int)1);
HXDLIN( 513)				int t = (_g1 - (int)1);
HXLINE( 515)				bool _hx_tmp;
HXDLIN( 515)				if (skipT) {
HXLINE( 515)					_hx_tmp = (hx::Mod(t,(int)3) == (int)0);
            				}
            				else {
...
HXLINE( 521)				tmp = uvt->get((t - (int)1));
HXLINE( 523)				if ((max < tmp)) {
HXLINE( 525)					max = tmp;
            				}
            			}
            		}
HXLINE( 531)		if (!(skipT)) {
HXLINE( 533)			return  ::Dynamic(hx::Anon_obj::Create(2)
            				->setFixed(0,HX_("max",a4,0a,53,00),max)
            				->setFixed(1,HX_("uvt",f3,2e,59,00),uvt));
            		}
HXLINE( 537)		int length = null();
HXDLIN( 537)		bool fixed = null();
HXDLIN( 537)		 ::openfl::_Vector::FloatVector result =  ::openfl::_Vector::FloatVector_obj::__alloc( HX_CTX ,length,fixed,null());
HXLINE( 539)		{
HXLINE( 539)			int _g11 = (int)1;
HXDLIN( 539)			int _g2 = (len + (int)1);
HXDLIN( 539)			while((_g11 < _g2)){
HXLINE( 539)				_g11 = (_g11 + (int)1);
HXDLIN( 539)				int t1 = (_g11 - (int)1);
HXLINE( 541)				bool _hx_tmp1;
HXDLIN( 541)				if (skipT) {
HXLINE( 541)					_hx_tmp1 = (hx::Mod(t1,(int)3) == (int)0);
            				}
            				else {
...
HXLINE( 547)				result->push(uvt->get((t1 - (int)1)));
            			}
            		}
HXLINE( 551)		return  ::Dynamic(hx::Anon_obj::Create(2)
            			->setFixed(0,HX_("max",a4,0a,53,00),max)
...
bool stroke = __o_stroke.Default(false);
            	HX_STACKFRAME(&_hx_pos_ca7a636da47018f2_556_playCommands)
            	}
...
void CanvasGraphics_obj::render( ::openfl::display::Graphics graphics, ::openfl::_internal::renderer::RenderSession renderSession, ::openfl::geom::Matrix parentTransform){
            	HX_STACKFRAME(&_hx_pos_ca7a636da47018f2_922_render)
            	}
...
void CanvasGraphics_obj::renderMask( ::openfl::display::Graphics graphics, ::openfl::_internal::renderer::RenderSession renderSession){
            	HX_STACKFRAME(&_hx_pos_ca7a636da47018f2_1421_renderMask)
            	}
...
void CanvasGraphics_obj::setSmoothing(bool smooth){
            	HX_STACKFRAME(&_hx_pos_ca7a636da47018f2_1529_setSmoothing)
            	}
...
HXLINE(  43)		SIN45 = ((Float)0.70710678118654752440084436210485);
            	}
{
            	HX_STACKFRAME(&_hx_pos_ca7a636da47018f2_44_boot)
HXLINE(  44)		TAN22 = ((Float)0.4142135623730950488016887242097);
            	}
{
            	HX_GC_STACKFRAME(&_hx_pos_ca7a636da47018f2_51_boot)
HXLINE(  51)		fillCommands =  ::openfl::_internal::renderer::DrawCommandBuffer_obj::__alloc( HX_CTX );
            	}
{
            	HX_GC_STACKFRAME(&_hx_pos_ca7a636da47018f2_58_boot)
HXLINE(  58)		strokeCommands =  ::openfl::_internal::renderer::DrawCommandBuffer_obj::__alloc( HX_CTX );
            	}
}
