...
HX_DEFINE_STACK_FRAME(_hx_pos_65d84bf4a5bd7bcf_157_new,"openfl.filters._ColorMatrixFilter.ColorMatrixShader","new",0xf11da59b,"openfl.filters._ColorMatrixFilter.ColorMatrixShader.new","openfl/filters/ColorMatrixFilter.hx",157,0xb64128b5)
HX_LOCAL_STACK_FRAME(_hx_pos_65d84bf4a5bd7bcf_169_init,"openfl.filters._ColorMatrixFilter.ColorMatrixShader","init",0x058bf975,"openfl.filters._ColorMatrixFilter.ColorMatrixShader.init","openfl/filters/ColorMatrixFilter.hx",169,0xb64128b5)
namespace openfl{
namespace filters{
namespace _ColorMatrixFilter{

void ColorMatrixShader_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_65d84bf4a5bd7bcf_157_new)
...
HXLINE( 162)		 ::Dynamic(this->get_data()->__Field(HX_("uMultipliers",5d,5b,61,e5),hx::paccDynamic))->__SetField(HX_("value",71,7f,b8,31),::cpp::VirtualArray_obj::__new(16)->init(0,(int)1)->init(1,(int)0)->init(2,(int)0)->init(3,(int)0)->init(4,(int)0)->init(5,(int)1)->init(6,(int)0)->init(7,(int)0)->init(8,(int)0)->init(9,(int)0)->init(10,(int)1)->init(11,(int)0)->init(12,(int)0)->init(13,(int)0)->init(14,(int)0)->init(15,(int)1),hx::paccDynamic);
HXLINE( 163)		 ::Dynamic(this->get_data()->__Field(HX_("uOffsets",8b,59,c4,c8),hx::paccDynamic))->__SetField(HX_("value",71,7f,b8,31),::cpp::VirtualArray_obj::__new(4)->init(0,(int)0)->init(1,(int)0)->init(2,(int)0)->init(3,(int)0),hx::paccDynamic);
            	}
...
void ColorMatrixShader_obj::init(::Array< Float > matrix){
            	HX_STACKFRAME(&_hx_pos_65d84bf4a5bd7bcf_169_init)
HXLINE( 171)		::Array< Float > multipliers = ( (::Array< Float >)( ::Dynamic(this->get_data()->__Field(HX_("uMultipliers",5d,5b,61,e5),hx::paccDynamic))->__Field(HX_("value",71,7f,b8,31),hx::paccDynamic)) );
HXLINE( 172)		::Array< Float > offsets = ( (::Array< Float >)( ::Dynamic(this->get_data()->__Field(HX_("uOffsets",8b,59,c4,c8),hx::paccDynamic))->__Field(HX_("value",71,7f,b8,31),hx::paccDynamic)) );
HXLINE( 174)		multipliers[(int)0] = matrix->__get((int)0);
HXLINE( 175)		multipliers[(int)1] = matrix->__get((int)1);
HXLINE( 176)		multipliers[(int)2] = matrix->__get((int)2);
HXLINE( 177)		multipliers[(int)3] = matrix->__get((int)3);
HXLINE( 178)		multipliers[(int)4] = matrix->__get((int)5);
HXLINE( 179)		multipliers[(int)5] = matrix->__get((int)6);
HXLINE( 180)		multipliers[(int)6] = matrix->__get((int)7);
HXLINE( 181)		multipliers[(int)7] = matrix->__get((int)8);
HXLINE( 182)		multipliers[(int)8] = matrix->__get((int)10);
HXLINE( 183)		multipliers[(int)9] = matrix->__get((int)11);
HXLINE( 184)		multipliers[(int)10] = matrix->__get((int)12);
HXLINE( 185)		multipliers[(int)11] = matrix->__get((int)13);
HXLINE( 186)		multipliers[(int)12] = matrix->__get((int)15);
HXLINE( 187)		multipliers[(int)13] = matrix->__get((int)16);
HXLINE( 188)		multipliers[(int)14] = matrix->__get((int)17);
HXLINE( 189)		multipliers[(int)15] = matrix->__get((int)18);
HXLINE( 191)		offsets[(int)0] = ((Float)matrix->__get((int)4) / (Float)((Float)255.0));
HXLINE( 192)		offsets[(int)1] = ((Float)matrix->__get((int)9) / (Float)((Float)255.0));
HXLINE( 193)		offsets[(int)2] = ((Float)matrix->__get((int)14) / (Float)((Float)255.0));
HXLINE( 194)		offsets[(int)3] = ((Float)matrix->__get((int)19) / (Float)((Float)255.0));
            	}
