...
HXLINE(  46)		return  ::openfl::filters::BlurFilter_obj::__alloc( HX_CTX ,this->blurX,this->blurY,this->quality);
            	}
...
HXDLIN( 108)			this->_hx___leftExtension = _hx_tmp;
HXLINE( 109)			this->_hx___rightExtension = this->_hx___leftExtension;
            		}
...
HXLINE(  20)		_hx___blurShader =  ::openfl::filters::_BlurFilter::BlurShader_obj::__alloc( HX_CTX );
            	}
}
