...
HX_LOCAL_STACK_FRAME(_hx_pos_7545faed7dab6ee1_86___initShader,"openfl.filters.ColorMatrixFilter","__initShader",0x2d28b6d8,"openfl.filters.ColorMatrixFilter.__initShader","openfl/filters/ColorMatrixFilter.hx",86,0xb64128b5)
HX_LOCAL_STACK_FRAME(_hx_pos_7545faed7dab6ee1_101_set_matrix,"openfl.filters.ColorMatrixFilter","set_matrix",0x82603721,"openfl.filters.ColorMatrixFilter.set_matrix","openfl/filters/ColorMatrixFilter.hx",101,0xb64128b5)
...
HXLINE(  81)		return destBitmapData;
            	}
 ...
 ::openfl::display::Shader ColorMatrixFilter_obj::_hx___initShader( ::openfl::_internal::renderer::RenderSession renderSession,int pass){
            	HX_STACKFRAME(&_hx_pos_7545faed7dab6ee1_86___initShader)
HXLINE(  88)		::openfl::filters::ColorMatrixFilter_obj::_hx___colorMatrixShader->init(this->matrix);
HXLINE(  89)		return ::openfl::filters::ColorMatrixFilter_obj::_hx___colorMatrixShader;
            	}


::Array< Float > ColorMatrixFilter_obj::set_matrix(::Array< Float > value){
            	HX_STACKFRAME(&_hx_pos_7545faed7dab6ee1_101_set_matrix)
HXLINE( 103)		if (hx::IsNull( value )) {
HXLINE( 105)			value = ::Array_obj< Float >::fromData( _hx_array_data_760a74eb_7,20);
            		}
HXLINE( 109)		return (this->matrix = value);
            	}
