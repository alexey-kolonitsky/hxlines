...
HXLINE(  40)		return  ::openfl::filters::BitmapFilter_obj::__alloc( HX_CTX );
            	}
...
HXLINE(  47)		return sourceBitmapData;
            	}
...
HXLINE(  54)		return renderSession->shaderManager->defaultShader;
            	}
