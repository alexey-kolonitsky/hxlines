...
HXLINE(  16)		switch((int)(_hx_getEnumValueIndex(value))){
            			case (int)0: {
...
HXLINE(  29)		::String _hx_switch_0 = value;
...
HXLINE(  42)		switch((int)(value)){
            			case (int)0: {
HXLINE(  42)				return ::lime::_hx_system::Endian_obj::_hx_BIG_ENDIAN_dyn();
            			}
            			break;
            			case (int)1: {
HXLINE(  42)				return ::lime::_hx_system::Endian_obj::_hx_LITTLE_ENDIAN_dyn();
            			}
            			break;
            			default:{
...
HXLINE(  55)		switch((int)(value)){
            			case (int)0: {
HXLINE(  55)				return HX_("bigEndian",7b,d5,5a,20);
            			}
            			break;
            			case (int)1: {
HXLINE(  55)				return HX_("littleEndian",31,2e,7b,07);
            			}
            			break;
            			default:{
...
HXLINE(  10)		_hx_BIG_ENDIAN = (int)0;
            	}
{
            	HX_STACKFRAME(&_hx_pos_f2873c031a8a146e_11_boot)
HXLINE(  11)		_hx_LITTLE_ENDIAN = (int)1;
            	}
}
