...
HXLINE(  84)		return this->bitmapData->get(id).StaticCast<  ::openfl::display::BitmapData >();
            	}
...
HXLINE(  91)		return this->font->get(id).StaticCast<  ::openfl::text::Font >();
            	}
...
HXLINE(  98)		return this->sound->get(id).StaticCast<  ::openfl::media::Sound >();
            	}
...
HXLINE( 105)		return this->bitmapData->exists(id);
            	}
...
HXLINE( 112)		return this->font->exists(id);
            	}
...
HXLINE( 119)		return this->sound->exists(id);
            	}
...
HXLINE( 150)		this->bitmapData->set(id,bitmapData);
            	}
...
HXLINE( 157)		this->font->set(id,font);
            	}
...
HXLINE( 164)		this->sound->set(id,sound);
            	}
...
HXLINE( 178)		return this->_hx___enabled;
            	}
...
HXLINE( 185)		return (this->_hx___enabled = value);
            	}
