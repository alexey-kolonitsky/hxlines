...
HXLINE( 632)		bool _hx_tmp = this->fixed;
...
HXLINE( 639)		return this->_hx___array->__get(index);
            	}
...
HXLINE( 663)			_hx_tmp = (index < this->_hx___array->length);
            		}
            		else {
...
HXLINE( 674)		return this->_hx___array->iterator();
            	}
...
HXLINE( 681)		return this->_hx___array->join(sep);
            	}
...
HXLINE( 742)			_hx_tmp = (index < this->_hx___array->length);
            		}
            		else {
...
HXLINE( 772)		return  ::openfl::_Vector::FloatVector_obj::__alloc( HX_CTX ,null(),null(),this->_hx___array->slice(startIndex,endIndex));
            	}
...
HXLINE( 779)		this->_hx___array->sort(f);
            	}
...
HXLINE( 786)		return  ::openfl::_Vector::FloatVector_obj::__alloc( HX_CTX ,null(),null(),this->_hx___array->splice(pos,len));
            	}
...
HXLINE( 793)		if (hx::IsNotNull( this->_hx___array )) {
HXLINE( 793)			return this->_hx___array->toString();
            		}
            		else {
...
HXLINE( 818)		return this->_hx___array->length;
            	}
