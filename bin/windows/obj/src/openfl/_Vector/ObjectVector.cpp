...
HXLINE(1509)		return  ::openfl::_Vector::ObjectVector_obj::__alloc( HX_CTX ,null(),null(),this->_hx___array->copy());
            	}
...
HXLINE(1516)		return this->_hx___array->__get(index);
            	}
...
HXLINE(1540)			_hx_tmp = (index < this->_hx___array->get_length());
            		}
            		else {
...
HXLINE(1551)		return this->_hx___array->iterator();
            	}
...
HXLINE(1558)		return this->_hx___array->join(sep);
            	}
...
HXLINE(1619)			_hx_tmp = (index < this->_hx___array->get_length());
            		}
            		else {
...
HXLINE(1649)		return  ::openfl::_Vector::ObjectVector_obj::__alloc( HX_CTX ,null(),null(),this->_hx___array->slice(startIndex,endIndex));
            	}
...
HXLINE(1656)		this->_hx___array->sort(f);
            	}
...
HXLINE(1663)		return  ::openfl::_Vector::ObjectVector_obj::__alloc( HX_CTX ,null(),null(),this->_hx___array->splice(pos,len));
            	}
...
HXLINE(1670)		if (hx::IsNotNull( this->_hx___array )) {
HXLINE(1670)			return this->_hx___array->toString();
            		}
            		else {
HXLINE(1670)			return null();
            		}
...
HXLINE(1695)		return this->_hx___array->get_length();
            	}
