...
HXLINE(1220)		bool _hx_tmp = this->fixed;
...
HXLINE(1227)		return this->_hx___array->__get(index);
            	}
...
HXLINE(1251)			_hx_tmp = (index < this->_hx___array->length);
            		}
            		else {
...
HXLINE(1262)		return this->_hx___array->iterator();
            	}
...
HXLINE(1269)		return this->_hx___array->join(sep);
            	}
...
HXLINE(1330)			_hx_tmp = (index < this->_hx___array->length);
            		}
            		else {
...
HXLINE(1360)		return  ::openfl::_Vector::IntVector_obj::__alloc( HX_CTX ,null(),null(),this->_hx___array->slice(startIndex,endIndex));
            	}
...
HXLINE(1367)		this->_hx___array->sort(f);
            	}
...
HXLINE(1374)		return  ::openfl::_Vector::IntVector_obj::__alloc( HX_CTX ,null(),null(),this->_hx___array->splice(pos,len));
            	}
...
HXLINE(1381)		if (hx::IsNotNull( this->_hx___array )) {
HXLINE(1381)			return this->_hx___array->toString();
            		}
            		else {
HXLINE(1381)			return null();
            		}
...
HXLINE(1406)		return this->_hx___array->length;
            	}
