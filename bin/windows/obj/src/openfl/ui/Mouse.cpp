...
HXLINE(  22)		::lime::ui::Mouse_obj::hide();
            	}
...
HXLINE(  29)		::lime::ui::Mouse_obj::show();
            	}
...
HXLINE(  43)		return ::openfl::ui::Mouse_obj::_hx___cursor;
            	}
...
HXLINE(  14)		supportsCursor = true;
            	}
{
            	HX_STACKFRAME(&_hx_pos_9dfd1f611dbbe53a_15_boot)
HXLINE(  15)		supportsNativeCursor = true;
            	}
{
            	HX_STACKFRAME(&_hx_pos_9dfd1f611dbbe53a_17_boot)
HXLINE(  17)		_hx___cursor = HX_("auto",6f,df,76,40);
            	}
}
