...
HXLINE(  27)		switch((int)(_hx_getEnumValueIndex(cursor))){
            			case (int)0: {
HXLINE(  27)				return HX_("arrow",c9,79,8f,25);
            			}
            			break;
            			case (int)1: {
HXLINE(  27)				return HX_("crosshair",a2,46,c8,8a);
            			}
            			break;
            			case (int)2: {
HXLINE(  27)				return HX_("auto",6f,df,76,40);
            			...
            			break;
            			case (int)3: {
HXLINE(  27)				return HX_("hand",6f,2b,08,45);
            			}
            			break;
            			case (int)4: {
HXLINE(  27)				return HX_("button",f2,61,e0,d9);
            			}
            			break;
            			case (int)5: {
HXLINE(  27)				return HX_("resize_nesw",06,ae,e9,a7);
            			}
            			break;
            			case (int)6: {
HXLINE(  27)				return HX_("resize_nwse",86,56,f7,a7);
            			}
            			break;
            			case (int)7: {
HXLINE(  27)				return HX_("resize_nwse",86,56,f7,a7);
            			...
            			break;
            			case (int)8: {
HXLINE(  27)				return HX_("resize_we",b9,d4,f2,ab);
            			}
            			break;
            			case (int)9: {
HXLINE(  27)				return HX_("ibeam",58,ca,26,b6);
            			}
            			break;
            			case (int)10: {
HXLINE(  27)				return HX_("wait",75,5a,f2,4e);
            			}
            			break;
            			case (int)11: {
HXLINE(  27)				return HX_("waitarrow",34,17,98,4f);
            			}
            			break;
            			case (int)12: {
HXLINE(  27)				return HX_("custom",b1,87,92,3f);
            			}
            			break;
            		}
...
HXLINE(   9)		ARROW = HX_("arrow",c9,79,8f,25);
            	}
{
            	HX_STACKFRAME(&_hx_pos_5ef75db01c4e3075_10_boot)
HXLINE(  10)		AUTO = HX_("auto",6f,df,76,40);
            	}
{
            	HX_STACKFRAME(&_hx_pos_5ef75db01c4e3075_11_boot)
HXLINE(  11)		BUTTON = HX_("button",f2,61,e0,d9);
            	}
{
            	HX_STACKFRAME(&_hx_pos_5ef75db01c4e3075_12_boot)
HXLINE(  12)		HAND = HX_("hand",6f,2b,08,45);
            	}
{
            	HX_STACKFRAME(&_hx_pos_5ef75db01c4e3075_13_boot)
HXLINE(  13)		IBEAM = HX_("ibeam",58,ca,26,b6);
            	}
{
            	HX_STACKFRAME(&_hx_pos_5ef75db01c4e3075_15_boot)
HXLINE(  15)		_hx___CROSSHAIR = HX_("crosshair",a2,46,c8,8a);
            	}
{
            	HX_STACKFRAME(&_hx_pos_5ef75db01c4e3075_16_boot)
HXLINE(  16)		_hx___CUSTOM = HX_("custom",b1,87,92,3f);
            	}
{
            	HX_STACKFRAME(&_hx_pos_5ef75db01c4e3075_17_boot)
HXLINE(  17)		_hx___MOVE = HX_("move",11,e3,60,48);
            	}
{
            	HX_STACKFRAME(&_hx_pos_5ef75db01c4e3075_18_boot)
HXLINE(  18)		_hx___RESIZE_NESW = HX_("resize_nesw",06,ae,e9,a7);
            	}
{
            	HX_STACKFRAME(&_hx_pos_5ef75db01c4e3075_19_boot)
HXLINE(  19)		_hx___RESIZE_NS = HX_("resize_ns",f0,cc,f2,ab);
            	}
{
            	HX_STACKFRAME(&_hx_pos_5ef75db01c4e3075_20_boot)
HXLINE(  20)		_hx___RESIZE_NWSE = HX_("resize_nwse",86,56,f7,a7);
            	}
{
            	HX_STACKFRAME(&_hx_pos_5ef75db01c4e3075_21_boot)
HXLINE(  21)		_hx___RESIZE_WE = HX_("resize_we",b9,d4,f2,ab);
            	}
{
            	HX_STACKFRAME(&_hx_pos_5ef75db01c4e3075_22_boot)
HXLINE(  22)		_hx___WAIT = HX_("wait",75,5a,f2,4e);
            	}
{
            	HX_STACKFRAME(&_hx_pos_5ef75db01c4e3075_23_boot)
HXLINE(  23)		_hx___WAIT_ARROW = HX_("waitarrow",34,17,98,4f);
            	}
}
