...
HXLINE(  30)		switch((int)(value)){
            			case (int)0: {
HXLINE(  30)				return HX_("bytes4",69,55,6f,27);
            			}
            			break;
            			case (int)1: {
HXLINE(  30)				return HX_("float1",15,23,56,41);
            			}
            			break;
            			case (int)2: {
HXLINE(  30)				return HX_("float2",16,23,56,41);
            			}
            			break;
            			case (int)3: {
HXLINE(  30)				return HX_("float3",17,23,56,41);
            			}
            			break;
            			case (int)4: {
HXLINE(  30)				return HX_("float4",18,23,56,41);
            			}
            			break;
            			default:{
