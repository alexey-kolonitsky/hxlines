...
HXLINE(  64)		 ::haxe::io::Bytes buffer = ::openfl::utils::_ByteArray::ByteArray_Impl__obj::toArrayBuffer(data);
HXDLIN(  64)		 ::lime::utils::ArrayBufferView this1;
HXDLIN(  64)		if (hx::IsNotNull( buffer )) {
HXLINE(  64)			 ::lime::utils::ArrayBufferView _this =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,(int)0,(int)4);
HXDLIN(  64)			int in_byteOffset = byteArrayOffset;
HXDLIN(  64)			if ((in_byteOffset < (int)0)) {
HXLINE(  64)				HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            			}
...
HXDLIN(  64)			{
HXLINE(  64)				newByteLength = (bufferByteLength - in_byteOffset);
...
HXLINE(  64)			HX_STACK_DO_THROW(HX_("Invalid constructor arguments for UInt8Array",6b,44,d5,85));
            		}
