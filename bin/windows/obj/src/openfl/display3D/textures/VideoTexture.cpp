...
HXLINE(  42)		this->_hx___netStream = netStream;
            	}
...
HXLINE(  85)		return this->_hx___textureID;
            	}


void VideoTexture_obj::_hx___textureReady(){
            	HX_GC_STACKFRAME(&_hx_pos_8bd748bb3c8a0c13_99___textureReady)
HXLINE(  99)		this->dispatchEvent( ::openfl::events::Event_obj::__alloc( HX_CTX ,HX_("textureReady",88,4d,5a,df),null(),null()));
            	}
