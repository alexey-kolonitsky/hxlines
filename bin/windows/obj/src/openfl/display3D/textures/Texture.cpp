...
HXLINE(  56)		 ::openfl::display3D::textures::Texture _gthis = hx::ObjectPtr<OBJ_>(this);
...
HXLINE( 142)		 ::haxe::io::Bytes buffer = ::openfl::utils::_ByteArray::ByteArray_Impl__obj::toArrayBuffer(data);
HXDLIN( 142)		 ::lime::utils::ArrayBufferView this1;
HXDLIN( 142)		if (hx::IsNotNull( buffer )) {
HXLINE( 142)			 ::lime::utils::ArrayBufferView _this =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,(int)0,(int)4);
...
HXDLIN( 142)			{
HXLINE( 142)				newByteLength = (bufferByteLength - in_byteOffset);
...
HXLINE( 142)			HX_STACK_DO_THROW(HX_("Invalid constructor arguments for UInt8Array",6b,44,d5,85));
            		}
...
HXLINE(  30)		_hx___lowMemoryMode = false;
            	}
}
