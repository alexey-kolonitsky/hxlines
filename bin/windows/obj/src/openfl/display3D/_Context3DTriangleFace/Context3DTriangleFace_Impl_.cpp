...
HXLINE(  28)		switch((int)(value)){
            			case (int)0: {
HXLINE(  28)				return HX_("back",27,da,10,41);
            			}
            			break;
            			case (int)1: {
HXLINE(  28)				return HX_("front",a9,18,8e,06);
            			}
            			break;
            			case (int)2: {
HXLINE(  28)				return HX_("frontAndBack",f5,1e,63,ce);
            			}
            			break;
            			case (int)3: {
