...
HXLINE(  32)		switch((int)(value)){
            			case (int)0: {
HXLINE(  32)				return HX_("bgrPacked565",6f,69,33,84);
            			}
            			break;
            			case (int)1: {
HXLINE(  32)				return HX_("bgra",b4,74,15,41);
            			}
            			break;
            			case (int)2: {
HXLINE(  32)				return HX_("bgraPacked4444",4c,10,af,4f);
            			}
            			break;
            			case (int)3: {
HXLINE(  32)				return HX_("compressed",81,4c,da,67);
            			}
            			break;
            			case (int)4: {
HXLINE(  32)				return HX_("compressedAlpha",1d,d7,1f,4a);
            			}
            			break;
            			case (int)5: {
HXLINE(  32)				return HX_("rgbaHalfFloat",95,5b,55,9e);
            			}
            			break;
            			default:{
