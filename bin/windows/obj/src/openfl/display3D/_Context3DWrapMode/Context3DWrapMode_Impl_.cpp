...
HXLINE(  14)		::String _hx_switch_0 = value;
...
HXLINE(  28)		switch((int)(value)){
            			case (int)0: {
HXLINE(  28)				return HX_("clamp",fb,72,58,48);
            			}
            			break;
            			case (int)1: {
HXLINE(  28)				return HX_("clamp_u_repeat_y",a3,8d,a7,28);
            			}
            			break;
            			case (int)2: {
HXLINE(  28)				return HX_("repeat",5b,97,7c,06);
            			}
            			break;
            			case (int)3: {
HXLINE(  28)				return HX_("repeat_u_clamp_y",c7,04,17,dd);
            			}
            			break;
            			default:{
