...
HX_DEFINE_STACK_FRAME(_hx_pos_f8a09bc4041285fc_96_new,"sys.io.Process","new",0x849b4c7a,"sys.io.Process.new","C:\\alexey\\apps\\haxe\\std/cpp/_std/sys/io/Process.hx",96,0xbae136d4)
HX_LOCAL_STACK_FRAME(_hx_pos_f8a09bc4041285fc_113_close,"sys.io.Process","close",0x0a954e52,"sys.io.Process.close","C:\\alexey\\apps\\haxe\\std/cpp/_std/sys/io/Process.hx",113,0xbae136d4)
namespace sys{
namespace io{

void Process_obj::__construct(::String cmd,::Array< ::String > args){
            	HX_GC_STACKFRAME(&_hx_pos_f8a09bc4041285fc_96_new)
...
void Process_obj::close(){
            	HX_STACKFRAME(&_hx_pos_f8a09bc4041285fc_113_close)
HXLINE( 113)		_hx_std_process_close(this->p);
            	}
