...
HX_DEFINE_STACK_FRAME(_hx_pos_2347ef85efa870ce_31_new,"sys.io._Process.Stdin","new",0xd3131563,"sys.io._Process.Stdin.new","C:\\alexey\\apps\\haxe\\std/cpp/_std/sys/io/Process.hx",31,0xbae136d4)
namespace sys{
namespace io{
namespace _Process{

void Stdin_obj::__construct( ::Dynamic p){
            	HX_STACKFRAME(&_hx_pos_2347ef85efa870ce_31_new)
HXLINE(  32)		this->p = p;
