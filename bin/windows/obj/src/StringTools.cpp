...
HX_LOCAL_STACK_FRAME(_hx_pos_8e8fafb3f7b63845_45_urlEncode,"StringTools","urlEncode",0x06afdce1,"StringTools.urlEncode","C:\\alexey\\apps\\haxe\\std/StringTools.hx",45,0x6226f5d1)
HX_LOCAL_STACK_FRAME(_hx_pos_8e8fafb3f7b63845_115_urlDecode,"StringTools","urlDecode",0x71b947f9,"StringTools.urlDecode","C:\\alexey\\apps\\haxe\\std/StringTools.hx",115,0x6226f5d1)
HX_LOCAL_STACK_FRAME(_hx_pos_8e8fafb3f7b63845_183_startsWith,"StringTools","startsWith",0x5f4e6efb,"StringTools.startsWith","C:\\alexey\\apps\\haxe\\std/StringTools.hx",183,0x6226f5d1)
HX_LOCAL_STACK_FRAME(_hx_pos_8e8fafb3f7b63845_211_endsWith,"StringTools","endsWith",0x0eb5bfe2,"StringTools.endsWith","C:\\alexey\\apps\\haxe\\std/StringTools.hx",211,0x6226f5d1)
HX_LOCAL_STACK_FRAME(_hx_pos_8e8fafb3f7b63845_331_lpad,"StringTools","lpad",0x23bd8feb,"StringTools.lpad","C:\\alexey\\apps\\haxe\\std/StringTools.hx",331,0x6226f5d1)
HX_LOCAL_STACK_FRAME(_hx_pos_8e8fafb3f7b63845_386_replace,"StringTools","replace",0x6d651f30,"StringTools.replace","C:\\alexey\\apps\\haxe\\std/StringTools.hx",386,0x6226f5d1)
HX_LOCAL_STACK_FRAME(_hx_pos_8e8fafb3f7b63845_396_hex,"StringTools","hex",0xd91debd7,"StringTools.hex","C:\\alexey\\apps\\haxe\\std/StringTools.hx",396,0x6226f5d1)
HX_LOCAL_STACK_FRAME(_hx_pos_8e8fafb3f7b63845_488_quoteUnixArg,"StringTools","quoteUnixArg",0xc59dac56,"StringTools.quoteUnixArg","C:\\alexey\\apps\\haxe\\std/StringTools.hx",488,0x6226f5d1)
HX_LOCAL_STACK_FRAME(_hx_pos_8e8fafb3f7b63845_521_quoteWinArg,"StringTools","quoteWinArg",0x7e16b8f2,"StringTools.quoteWinArg","C:\\alexey\\apps\\haxe\\std/StringTools.hx",521,0x6226f5d1)
...
HX_LOCAL_STACK_FRAME(_hx_pos_8e8fafb3f7b63845_506_boot,"StringTools","boot",0x1d20b7b6,"StringTools.boot","C:\\alexey\\apps\\haxe\\std/StringTools.hx",506,0x6226f5d1)
...
::String StringTools_obj::urlEncode(::String s){
            	HX_STACKFRAME(&_hx_pos_8e8fafb3f7b63845_45_urlEncode)
...
::String StringTools_obj::urlDecode(::String s){
            	HX_STACKFRAME(&_hx_pos_8e8fafb3f7b63845_115_urlDecode)
...
bool StringTools_obj::startsWith(::String s,::String start){
            	HX_STACKFRAME(&_hx_pos_8e8fafb3f7b63845_183_startsWith)
...
bool StringTools_obj::endsWith(::String s,::String end){
            	HX_STACKFRAME(&_hx_pos_8e8fafb3f7b63845_211_endsWith)
...
::String StringTools_obj::lpad(::String s,::String c,int l){
            	HX_STACKFRAME(&_hx_pos_8e8fafb3f7b63845_331_lpad)
...
::String StringTools_obj::replace(::String s,::String sub,::String by){
            	HX_STACKFRAME(&_hx_pos_8e8fafb3f7b63845_386_replace)
...
::String StringTools_obj::hex(int n, ::Dynamic digits){
            	HX_STACKFRAME(&_hx_pos_8e8fafb3f7b63845_396_hex)
...
::String StringTools_obj::quoteUnixArg(::String argument){
            	HX_GC_STACKFRAME(&_hx_pos_8e8fafb3f7b63845_488_quoteUnixArg)
...
::String StringTools_obj::quoteWinArg(::String argument,bool escapeMetaCharacters){
            	HX_GC_STACKFRAME(&_hx_pos_8e8fafb3f7b63845_521_quoteWinArg)
...
{
{
            	HX_STACKFRAME(&_hx_pos_8e8fafb3f7b63845_506_boot)
HXLINE( 506)		winMetaCharacters = ::Array_obj< int >::fromData( _hx_array_data_0363db6a_22,15);
            	}
}
