...
HXLINE(  54)		return (((int)this1 & (int)(int)4) > (int)0);
            	}
...
HXLINE(  78)		return (((int)this1 & (int)(int)8) > (int)0);
            	}
...
HXLINE( 102)		return (((int)this1 & (int)(int)2) > (int)0);
            	}
...
HXLINE( 126)		return (((int)this1 & (int)(int)1) > (int)0);
            	}
