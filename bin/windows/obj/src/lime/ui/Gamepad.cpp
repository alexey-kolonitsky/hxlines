...
HXLINE(  82)		return ( ( ::Dynamic)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_gamepad_get_device_guid(this->id)) );
            	}
...
HXLINE(  96)		return ( ( ::Dynamic)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_gamepad_get_device_name(this->id)) );
            	}
...
HXLINE(  43)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gamepad_add_mappings(hx::DynamicPtr(mappings));
            	}
...
HXLINE(  51)		if (!(::lime::ui::Gamepad_obj::devices->exists(id))) {
...
HXLINE(  19)		devices =  ::haxe::ds::IntMap_obj::__alloc( HX_CTX );
            	}
{
            	HX_GC_STACKFRAME(&_hx_pos_b33f1f9ffbdc366b_20_boot)
HXLINE(  20)		onConnect =  ::lime::app::_Event_lime_ui_Gamepad_Void_obj::__alloc( HX_CTX );
            	}
}
