...
HXLINE(  15)		onEnd =  ::lime::app::_Event_lime_ui_Touch_Void_obj::__alloc( HX_CTX );
            	}
{
            	HX_GC_STACKFRAME(&_hx_pos_c51b2e87fb75d55f_16_boot)
HXLINE(  16)		onMove =  ::lime::app::_Event_lime_ui_Touch_Void_obj::__alloc( HX_CTX );
            	}
{
            	HX_GC_STACKFRAME(&_hx_pos_c51b2e87fb75d55f_17_boot)
HXLINE(  17)		onStart =  ::lime::app::_Event_lime_ui_Touch_Void_obj::__alloc( HX_CTX );
            	}
}
