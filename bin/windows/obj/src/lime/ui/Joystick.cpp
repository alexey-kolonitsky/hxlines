...
HXLINE(  87)		return ( ( ::Dynamic)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_joystick_get_device_guid(this->id)) );
            	}
...
HXLINE( 101)		return ( ( ::Dynamic)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_joystick_get_device_name(this->id)) );
            	}
...
HXLINE( 115)		return ::lime::_backend::native::NativeCFFI_obj::cffi_lime_joystick_get_num_axes(this->id);
            	}
...
HXLINE( 129)		return ::lime::_backend::native::NativeCFFI_obj::cffi_lime_joystick_get_num_buttons(this->id);
            	}
...
HXLINE( 143)		return ::lime::_backend::native::NativeCFFI_obj::cffi_lime_joystick_get_num_hats(this->id);
            	}
...
HXLINE( 154)		return ::lime::_backend::native::NativeCFFI_obj::cffi_lime_joystick_get_num_trackballs(this->id);
            	}
...
HXLINE(  47)		if (!(::lime::ui::Joystick_obj::devices->exists(id))) {
...
HXLINE(  18)		devices =  ::haxe::ds::IntMap_obj::__alloc( HX_CTX );
            	}
{
            	HX_GC_STACKFRAME(&_hx_pos_1f03a5186095f658_19_boot)
HXLINE(  19)		onConnect =  ::lime::app::_Event_lime_ui_Joystick_Void_obj::__alloc( HX_CTX );
            	}
}
