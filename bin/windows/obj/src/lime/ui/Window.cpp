...
HXLINE( 121)		this->backend->alert(message,title);
            	}
...
HXLINE( 402)		return HX_("[object Window]",87,e9,90,f1);
            	}
...
HXLINE( 416)		return this->backend->getDisplay();
            	}
...
HXLINE( 423)		return this->backend->getDisplayMode();
            	}
...
HXLINE( 430)		return this->backend->setDisplayMode(value);
            	}
...
HXLINE( 437)		return this->_hx___borderless;
            	}
...
HXLINE( 444)		return (this->_hx___borderless = this->backend->setBorderless(value));
            	}
...
HXLINE( 451)		return this->backend->getEnableTextEvents();
            	}
...
HXLINE( 458)		return this->backend->setEnableTextEvents(value);
            	}
...
HXLINE( 465)		return this->_hx___fullscreen;
            	}
...
HXLINE( 472)		return (this->_hx___fullscreen = this->backend->setFullscreen(value));
            	}
...
HXLINE( 494)		return this->_hx___maximized;
            	}
...
HXLINE( 509)		return this->_hx___minimized;
            	}
...
HXLINE( 524)		return this->_hx___resizable;
            	}
...
HXLINE( 539)		return this->_hx___scale;
            	}
...
HXLINE( 546)		return this->_hx___title;
            	}
...
HXLINE( 553)		return (this->_hx___title = this->backend->setTitle(value));
            	}
...
HXLINE( 560)		return this->_hx___width;
            	}
...
HXLINE( 590)		return this->_hx___y;
            	}
...
hx::Val Window_obj::__SetField(const ::String &inName,const hx::Val &inValue,hx::PropertyAccess inCallProp)
{
	...
	case 11:
		...
		if (HX_FIELD_EQ(inName,"displayMode") ) { if (inCallProp == hx::paccAlways) return hx::Val( set_displayMode(inValue) ); }
