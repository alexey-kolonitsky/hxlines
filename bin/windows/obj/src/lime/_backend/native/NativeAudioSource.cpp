...
HXLINE(  58)		if (hx::IsNotNull( this->handle )) {
...
HXLINE( 443)		return ::lime::media::openal::AL_obj::getSourcef(this->handle,(int)4106);
            	}
...
HXLINE( 504)		return (this->loops = value);
            	}
