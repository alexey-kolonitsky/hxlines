...
HXLINE(  27)		return ( ( ::Dynamic)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_cairo_ft_font_face_create(hx::DynamicPtr(face->src),loadFlags)) );
            	}
...
HXLINE(  14)		FT_LOAD_FORCE_AUTOHINT = (int)32;
            	}
}
