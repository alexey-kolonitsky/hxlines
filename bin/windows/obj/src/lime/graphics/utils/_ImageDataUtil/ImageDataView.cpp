...
HX_DEFINE_STACK_FRAME(_hx_pos_ca97c355311e00fd_1535_new,"lime.graphics.utils._ImageDataUtil.ImageDataView","new",0xaa0478bd,"lime.graphics.utils._ImageDataUtil.ImageDataView.new","lime/graphics/utils/ImageDataUtil.hx",1535,0x494d921f)
HX_LOCAL_STACK_FRAME(_hx_pos_ca97c355311e00fd_1566_clip,"lime.graphics.utils._ImageDataUtil.ImageDataView","clip",0x12a517d3,"lime.graphics.utils._ImageDataUtil.ImageDataView.clip","lime/graphics/utils/ImageDataUtil.hx",1566,0x494d921f)
HX_LOCAL_STACK_FRAME(_hx_pos_ca97c355311e00fd_1581_row,"lime.graphics.utils._ImageDataUtil.ImageDataView","row",0xaa078a77,"lime.graphics.utils._ImageDataUtil.ImageDataView.row","lime/graphics/utils/ImageDataUtil.hx",1581,0x494d921f)
namespace lime{
namespace graphics{
namespace utils{
...
void ImageDataView_obj::__construct( ::lime::graphics::Image image, ::lime::math::Rectangle rect){
            	HX_STACKFRAME(&_hx_pos_ca97c355311e00fd_1535_new)
HXLINE(1537)		this->image = image;
HXLINE(1539)		if (hx::IsNull( rect )) {
HXLINE(1541)			this->rect = image->get_rect();
            		}
            		else {
HXLINE(1545)			if ((rect->x < (int)0)) {
HXLINE(1545)				rect->x = (int)0;
            			}
HXLINE(1546)			if ((rect->y < (int)0)) {
HXLINE(1546)				rect->y = (int)0;
            			}
HXLINE(1547)			if (((rect->x + rect->width) > image->width)) {
HXLINE(1547)				rect->width = (image->width - rect->x);
            			}
HXLINE(1548)			if (((rect->y + rect->height) > image->height)) {
HXLINE(1548)				rect->height = (image->height - rect->y);
            			}
HXLINE(1549)			if ((rect->width < (int)0)) {
HXLINE(1549)				rect->width = (int)0;
            			}
HXLINE(1550)			if ((rect->height < (int)0)) {
HXLINE(1550)				rect->height = (int)0;
            			}
HXLINE(1551)			this->rect = rect;
            		}
HXLINE(1555)		this->stride = image->buffer->get_stride();
HXLINE(1557)		this->x = ::Math_obj::ceil(this->rect->x);
HXLINE(1558)		this->y = ::Math_obj::ceil(this->rect->y);
HXLINE(1559)		this->width = ::Math_obj::floor(this->rect->width);
HXLINE(1560)		this->height = ::Math_obj::floor(this->rect->height);
HXLINE(1561)		int _hx_tmp = this->stride;
HXDLIN(1561)		int _hx_tmp1 = (_hx_tmp * (this->y + image->offsetY));
HXDLIN(1561)		this->offset = (_hx_tmp1 + ((this->x + image->offsetX) * (int)4));
            	}
...
void ImageDataView_obj::clip(int x,int y,int width,int height){
            	HX_STACKFRAME(&_hx_pos_ca97c355311e00fd_1566_clip)
HXLINE(1568)		this->rect->_hx___contract(x,y,width,height);
HXLINE(1570)		this->x = ::Math_obj::ceil(this->rect->x);
HXLINE(1571)		this->y = ::Math_obj::ceil(this->rect->y);
HXLINE(1572)		this->width = ::Math_obj::floor(this->rect->width);
HXLINE(1573)		this->height = ::Math_obj::floor(this->rect->height);
HXLINE(1574)		int _hx_tmp = this->stride;
HXDLIN(1574)		int _hx_tmp1 = (_hx_tmp * (this->y + this->image->offsetY));
HXDLIN(1574)		this->offset = (_hx_tmp1 + ((this->x + this->image->offsetX) * (int)4));
            	}
...
int ImageDataView_obj::row(int y){
            	HX_STACKFRAME(&_hx_pos_ca97c355311e00fd_1581_row)
HXLINE(1581)		int _hx_tmp = this->offset;
HXDLIN(1581)		return (_hx_tmp + (this->stride * y));
            	}
