...
HXLINE( 110)		this->libraries->push(library);
            	}
...
HXLINE( 117)		if ((this->libraryNames->indexOf(name,null()) == (int)-1)) {
...
HXLINE( 140)		 ::lime::app::Preloader _gthis = hx::ObjectPtr<OBJ_>(this);
HXLINE( 142)		{
...
HXLINE( 262)		 ::lime::app::Preloader _gthis = hx::ObjectPtr<OBJ_>(this);
