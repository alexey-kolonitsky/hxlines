...
HXLINE(  57)		this->backend->dispose();
            	}
...
HXLINE(  99)		return this->backend->getCurrentTime();
            	}
...
HXLINE( 106)		return this->backend->setCurrentTime(value);
            	}
...
HXLINE( 113)		return this->backend->getGain();
            	}
...
HXLINE( 120)		return this->backend->setGain(value);
            	}
...
HXLINE( 127)		return this->backend->getLength();
            	}
...
HXLINE( 134)		return this->backend->setLength(value);
            	}
...
HXLINE( 141)		return this->backend->getLoops();
            	}
...
HXLINE( 148)		return this->backend->setLoops(value);
            	}
...
HXLINE( 155)		return this->backend->getPosition();
            	}
...
HXLINE( 162)		return this->backend->setPosition(value);
            	}
