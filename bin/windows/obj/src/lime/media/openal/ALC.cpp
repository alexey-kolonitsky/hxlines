...
HXLINE(  44)		return ::lime::_backend::native::NativeCFFI_obj::cffi_lime_alc_close_device(hx::DynamicPtr(device));
            	}
...
HXLINE(  72)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_alc_destroy_context(hx::DynamicPtr(context));
            	}
...
HXLINE( 115)		return ::lime::_backend::native::NativeCFFI_obj::cffi_lime_alc_get_error(hx::DynamicPtr(device));
            	}
...
HXLINE( 125)		int _g = ::lime::media::openal::ALC_obj::getError(device);
HXDLIN( 125)		switch((int)(_g)){
            			case (int)40961: {
HXLINE( 125)				return HX_("INVALID_DEVICE: Invalid device (or no device?)",8d,16,8a,9d);
            			}
            			break;
            			case (int)40962: {
HXLINE( 125)				return HX_("INVALID_CONTEXT: Invalid context (or no context?)",56,39,91,8b);
            			}
            			break;
            			case (int)40963: {
HXLINE( 125)				return HX_("INVALID_ENUM: Invalid enum value",0a,d7,df,59);
            			}
            			break;
            			case (int)40964: {
HXLINE( 125)				return HX_("INVALID_VALUE: Invalid param value",a6,0e,30,55);
            			}
            			break;
            			case (int)40965: {
HXLINE( 125)				return HX_("OUT_OF_MEMORY: OpenAL has run out of memory",b0,dd,fb,0a);
            			}
            			break;
            			default:{
HXLINE( 125)				return HX_("",00,00,00,00);
            			}
            		}
...
HXLINE( 142)		return ( ( ::Dynamic)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_alc_get_integerv(hx::DynamicPtr(device),param,size)) );
            	}
...
HXLINE( 153)		return ( ( ::Dynamic)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_alc_get_string(hx::DynamicPtr(device),param)) );
            	}
...
HXLINE( 164)		return ::lime::_backend::native::NativeCFFI_obj::cffi_lime_alc_make_context_current(hx::DynamicPtr(context));
            	}
...
HXLINE( 192)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_alc_pause_device(hx::DynamicPtr(device));
            	}
...
HXLINE( 201)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_alc_process_context(hx::DynamicPtr(context));
            	}
...
HXLINE( 210)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_alc_resume_device(hx::DynamicPtr(device));
            	}
...
HXLINE( 219)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_alc_suspend_context(hx::DynamicPtr(context));
            	}
