...
HXLINE(  71)			_hx_tmp2 = (code <= (int)1114111);
            		}
            		else {
...
HXLINE(  71)				_hx_tmp3 = (code <= (int)56319);
            			}
            			else {
...
HXLINE(  71)				_hx_tmp4 = (code <= (int)57343);
            			}
            			else {
...
HXLINE(  71)			HX_STACK_DO_THROW( ::lime::text::unifill::InvalidCodePoint_obj::__alloc( HX_CTX ,code));
            		}
...
HXLINE(  71)			buf->b->push(this2);
            		}
            		else {
HXLINE(  71)			if ((this2 <= (int)2047)) {
HXLINE(  71)				::Array< unsigned char > buf1 = buf->b;
...
HXLINE(  71)				if ((this2 <= (int)65535)) {
HXLINE(  71)					::Array< unsigned char > buf3 = buf->b;
...
HXLINE(  71)					if ((this2 <= (int)1114111)) {
HXLINE(  71)						::Array< unsigned char > buf6 = buf->b;
...
HXLINE(  71)						HX_STACK_DO_THROW( ::lime::text::unifill::InvalidCodePoint_obj::__alloc( HX_CTX ,this2));
            					}
            				}
            			}
            		}
...
HXLINE( 110)		::String this2 = this1;
HXDLIN( 110)		::String this3 = this2;
HXDLIN( 110)		::String this4 = this3;
HXDLIN( 110)		int index;
HXDLIN( 110)		if ((startIndex >= (int)0)) {
HXLINE( 110)			int index1 = (int)0;
HXDLIN( 110)			int len = this4.length;
HXDLIN( 110)			int i = (int)0;
HXDLIN( 110)			while(true){
HXLINE( 110)				bool index2;
HXDLIN( 110)				if ((i < startIndex)) {
HXLINE( 110)					index2 = (index1 < len);
            				}
            				else {
HXLINE( 110)					index2 = false;
            				}
HXDLIN( 110)				if (!(index2)) {
HXLINE( 110)					goto _hx_goto_6;
            				}
HXDLIN( 110)				int c = this4.cca(index1);
HXDLIN( 110)				int index3;
HXDLIN( 110)				if ((c < (int)192)) {
HXLINE( 110)					index3 = (int)1;
            				}
            				else {
HXLINE( 110)					if ((c < (int)224)) {
HXLINE( 110)						index3 = (int)2;
            					}
            					else {
HXLINE( 110)						if ((c < (int)240)) {
HXLINE( 110)							index3 = (int)3;
            						}
            						else {
HXLINE( 110)							if ((c < (int)248)) {
HXLINE( 110)								index3 = (int)4;
            							}
            							else {
HXLINE( 110)								index3 = (int)1;
            							}
...
HXLINE( 110)			int index4 = (int)0;
HXDLIN( 110)			int count = (int)0;
HXDLIN( 110)			while(true){
HXLINE( 110)				bool index5;
HXDLIN( 110)				if ((count < -(startIndex))) {
HXLINE( 110)					index5 = ((int)0 < index4);
            				}
            				else {
HXLINE( 110)					index5 = false;
            				}
...
HXLINE( 110)			::String this10 = this1;
...
HXLINE( 128)		 ::Dynamic startIndex1 = startIndex;
HXDLIN( 128)		if (hx::IsNull( startIndex1 )) {
HXLINE( 128)			startIndex1 = (this1.length - (int)1);
            		}
...
HXLINE( 128)					index3 = (int)1;
            				}
            				else {
HXLINE( 128)					if ((c < (int)224)) {
HXLINE( 128)						index3 = (int)2;
            					}
            					else {
HXLINE( 128)						if ((c < (int)240)) {
HXLINE( 128)							index3 = (int)3;
            						}
            						else {
HXLINE( 128)							if ((c < (int)248)) {
HXLINE( 128)								index3 = (int)4;
            							}
            							else {
HXLINE( 128)								index3 = (int)1;
            							}
...
HXLINE( 128)			int index4 = (int)0;
HXDLIN( 128)			int count = (int)0;
HXDLIN( 128)			while(true){
HXLINE( 128)				bool index5;
HXDLIN( 128)				if ((count < -(codePointOffset))) {
HXLINE( 128)					index5 = ((int)0 < index4);
            				}
            				else {
HXLINE( 128)					index5 = false;
            				}
HXDLIN( 128)				if (!(index5)) {
HXLINE( 128)					goto _hx_goto_10;
            				}
...
HXLINE( 128)					index7 = (c1 >= (int)192);
            				}
            				else {
HXLINE( 128)					index7 = true;
            				}
HXDLIN( 128)				if (index7) {
HXLINE( 128)					index6 = (int)1;
            				}
            				else {
HXLINE( 128)					::String this7 = this5;
HXDLIN( 128)					if ((((int)this7.cca((index4 - (int)2)) & (int)(int)224) == (int)192)) {
HXLINE( 128)						index6 = (int)2;
            					}
            					else {
HXLINE( 128)						::String this8 = this5;
HXDLIN( 128)						if ((((int)this8.cca((index4 - (int)3)) & (int)(int)240) == (int)224)) {
HXLINE( 128)							index6 = (int)3;
            						}
            						else {
HXLINE( 128)							::String this9 = this5;
HXDLIN( 128)							if ((((int)this9.cca((index4 - (int)4)) & (int)(int)248) == (int)240)) {
HXLINE( 128)								index6 = (int)4;
            							}
            							else {
HXLINE( 128)								index6 = (int)1;
            							}
...
HXLINE( 128)			::String this10 = this1;
...
HXLINE( 155)						_g1_index1 = (int)1;
            					}
            					else {
HXLINE( 155)						if ((c < (int)224)) {
HXLINE( 155)							_g1_index1 = (int)2;
            						}
            						else {
HXLINE( 155)							if ((c < (int)240)) {
HXLINE( 155)								_g1_index1 = (int)3;
            							}
            							else {
HXLINE( 155)								if ((c < (int)248)) {
HXLINE( 155)									_g1_index1 = (int)4;
            								}
            								else {
HXLINE( 155)									_g1_index1 = (int)1;
            								}
...
HXLINE( 155)						len = (int)1;
            					}
            					else {
HXLINE( 155)						if ((c1 < (int)224)) {
HXLINE( 155)							len = (int)2;
            						}
            						else {
HXLINE( 155)							if ((c1 < (int)240)) {
HXLINE( 155)								len = (int)3;
            							}
            							else {
HXLINE( 155)								if ((c1 < (int)248)) {
HXLINE( 155)									len = (int)4;
            								}
            								else {
HXLINE( 155)									len = (int)1;
            								}
...
HXLINE( 155)			return this1.split(delimiter);
            		}
...
HXLINE( 177)		return ::haxe::Utf8_obj::sub(this1,pos,len);
            	}
...
HXLINE( 197)						si1 = (index < len);
            					}
            					else {
HXLINE( 197)						si1 = false;
            					}
HXDLIN( 197)					if (!(si1)) {
HXLINE( 197)						goto _hx_goto_15;
            					}
HXDLIN( 197)					int c = this4.cca(index);
HXDLIN( 197)					int index1;
HXDLIN( 197)					if ((c < (int)192)) {
HXLINE( 197)						index1 = (int)1;
            					}
            					else {
HXLINE( 197)						if ((c < (int)224)) {
HXLINE( 197)							index1 = (int)2;
            						}
            						else {
HXLINE( 197)							if ((c < (int)240)) {
HXLINE( 197)								index1 = (int)3;
            							}
            							else {
HXLINE( 197)								if ((c < (int)248)) {
HXLINE( 197)									index1 = (int)4;
            								}
            								else {
HXLINE( 197)									index1 = (int)1;
            								}
...
HXLINE( 197)				int index2 = (int)0;
HXDLIN( 197)				int count = (int)0;
HXDLIN( 197)				while(true){
HXLINE( 197)					bool si2;
HXDLIN( 197)					if ((count < -(startIndex))) {
HXLINE( 197)						si2 = ((int)0 < index2);
            					}
            					else {
HXLINE( 197)						si2 = false;
            					}
HXDLIN( 197)					if (!(si2)) {
HXLINE( 197)						goto _hx_goto_16;
            					}
...
HXLINE( 197)						index4 = (c1 >= (int)192);
            					}
            					else {
HXLINE( 197)						index4 = true;
            					}
HXDLIN( 197)					if (index4) {
HXLINE( 197)						index3 = (int)1;
            					}
            					else {
HXLINE( 197)						::String this7 = this5;
HXDLIN( 197)						if ((((int)this7.cca((index2 - (int)2)) & (int)(int)224) == (int)192)) {
HXLINE( 197)							index3 = (int)2;
            						}
            						else {
HXLINE( 197)							::String this8 = this5;
HXDLIN( 197)							if ((((int)this8.cca((index2 - (int)3)) & (int)(int)240) == (int)224)) {
HXLINE( 197)								index3 = (int)3;
            							}
            							else {
HXLINE( 197)								::String this9 = this5;
HXDLIN( 197)								if ((((int)this9.cca((index2 - (int)4)) & (int)(int)248) == (int)240)) {
HXLINE( 197)									index3 = (int)4;
            								}
            								else {
HXLINE( 197)									index3 = (int)1;
            								}
...
HXLINE( 197)			ei = this1.length;
            		}
            		else {
HXLINE( 197)			if (hx::IsLess( endIndex,(int)0 )) {
HXLINE( 197)				ei = (int)0;
            			}
            			else {
HXLINE( 197)				int codePointOffset = endIndex;
...
HXLINE( 197)					int index5 = (int)0;
HXDLIN( 197)					int len1 = this12.length;
HXDLIN( 197)					int i1 = (int)0;
HXDLIN( 197)					while(true){
HXLINE( 197)						bool ei1;
HXDLIN( 197)						if ((i1 < codePointOffset)) {
HXLINE( 197)							ei1 = (index5 < len1);
            						}
            						else {
HXLINE( 197)							ei1 = false;
            						}
HXDLIN( 197)						if (!(ei1)) {
HXLINE( 197)							goto _hx_goto_17;
            						}
HXDLIN( 197)						int c2 = this12.cca(index5);
HXDLIN( 197)						int index6;
HXDLIN( 197)						if ((c2 < (int)192)) {
HXLINE( 197)							index6 = (int)1;
            						}
            						else {
HXLINE( 197)							if ((c2 < (int)224)) {
HXLINE( 197)								index6 = (int)2;
            							}
            							else {
HXLINE( 197)								if ((c2 < (int)240)) {
HXLINE( 197)									index6 = (int)3;
            								}
            								else {
HXLINE( 197)									if ((c2 < (int)248)) {
HXLINE( 197)										index6 = (int)4;
            									}
            									else {
HXLINE( 197)										index6 = (int)1;
            									}
...
HXLINE( 197)					int index7 = (int)0;
HXDLIN( 197)					int count1 = (int)0;
HXDLIN( 197)					while(true){
HXLINE( 197)						bool ei2;
HXDLIN( 197)						if ((count1 < -(codePointOffset))) {
HXLINE( 197)							ei2 = ((int)0 < index7);
            						}
            						else {
HXLINE( 197)							ei2 = false;
            						}
HXDLIN( 197)						if (!(ei2)) {
HXLINE( 197)							goto _hx_goto_18;
            						}
...
HXLINE( 197)							index9 = (c11 >= (int)192);
            						}
            						else {
HXLINE( 197)							index9 = true;
            						}
HXDLIN( 197)						if (index9) {
HXLINE( 197)							index8 = (int)1;
            						}
            						else {
HXLINE( 197)							::String this15 = this13;
HXDLIN( 197)							if ((((int)this15.cca((index7 - (int)2)) & (int)(int)224) == (int)192)) {
HXLINE( 197)								index8 = (int)2;
            							}
            							else {
HXLINE( 197)								::String this16 = this13;
HXDLIN( 197)								if ((((int)this16.cca((index7 - (int)3)) & (int)(int)240) == (int)224)) {
HXLINE( 197)									index8 = (int)3;
            								}
            								else {
HXLINE( 197)									::String this17 = this13;
HXDLIN( 197)									if ((((int)this17.cca((index7 - (int)4)) & (int)(int)248) == (int)240)) {
HXLINE( 197)										index8 = (int)4;
            									}
            									else {
HXLINE( 197)										index8 = (int)1;
            									}
...
HXLINE( 342)		return ::Std_obj::string(value);
            	}
...
HXLINE( 356)		if (hx::IsNull( this1 )) {
HXLINE( 356)			return (int)0;
            		}
            		else {
HXLINE( 356)			return ::haxe::Utf8_obj::length(this1);
            		}
