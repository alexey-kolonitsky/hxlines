...
HXLINE(  22)		this1 = ((int)this1 ^ (int)(int)1);
            	}
...
HXLINE(  29)		switch((int)(this1)){
            			case (int)4: {
HXLINE(  29)				return HX_("leftToRight",1a,97,7b,b5);
            			}
            			break;
            			case (int)5: {
HXLINE(  29)				return HX_("rightToLeft",1e,40,ee,e6);
            			}
            			break;
            			case (int)6: {
HXLINE(  29)				return HX_("topToBottom",7b,ce,19,75);
            			}
            			break;
            			case (int)7: {
HXLINE(  29)				return HX_("bottomToTop",ef,ac,aa,79);
            			}
            			break;
            			default:{
HXLINE(  29)				return HX_("",00,00,00,00);
            			}
            		}
...
HXLINE(  44)		return (((int)this1 & (int)(int)-3) == (int)5);
            	}
...
HXLINE(  51)		return (((int)this1 & (int)(int)-3) == (int)4);
            	}
...
HXLINE(  58)		return (((int)this1 & (int)(int)-2) == (int)4);
            	}
...
HXLINE(  65)		return (((int)this1 & (int)(int)-2) == (int)6);
            	}
