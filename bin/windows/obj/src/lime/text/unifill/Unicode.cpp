...
HXLINE(  13)		return ((int)((int)(hi - (int)55232) << (int)(int)10) | (int)((int)lo & (int)(int)1023));
            	}
...
HXLINE(  16)		return (((int)c >> (int)(int)10) + (int)55232);
            	}
...
HXLINE(  19)		return ((int)((int)c & (int)(int)1023) | (int)(int)56320);
            	}
...
HXLINE(  22)			_hx_tmp1 = (code <= (int)1114111);
            		}
            		else {
...
HXLINE(  22)				_hx_tmp2 = (code <= (int)56319);
            			}
            			else {
...
HXLINE(  22)				_hx_tmp3 = (code <= (int)57343);
            			}
            			else {
...
HXLINE(  26)		if (((int)55296 <= code)) {
HXLINE(  26)			return (code <= (int)56319);
            		}
            		else {
...
HXLINE(  30)		if (((int)56320 <= code)) {
HXLINE(  30)			return (code <= (int)57343);
            		}
            		else {
