...
HXLINE(  21)		int codePoint = ::haxe::Utf8_obj::charCodeAt(s,index);
HXDLIN(  21)		 ::haxe::io::BytesBuffer buf =  ::haxe::io::BytesBuffer_obj::__alloc( HX_CTX );
HXDLIN(  21)		if ((codePoint <= (int)127)) {
HXLINE(  21)			buf->b->push(codePoint);
            		}
            		else {
HXLINE(  21)			if ((codePoint <= (int)2047)) {
HXLINE(  21)				::Array< unsigned char > buf1 = buf->b;
...
HXLINE(  21)				if ((codePoint <= (int)65535)) {
HXLINE(  21)					::Array< unsigned char > buf3 = buf->b;
...
HXLINE(  21)					if ((codePoint <= (int)1114111)) {
HXLINE(  21)						::Array< unsigned char > buf6 = buf->b;
...
HXLINE(  21)						HX_STACK_DO_THROW( ::lime::text::unifill::InvalidCodePoint_obj::__alloc( HX_CTX ,codePoint));
            					}
            				}
            			}
            		}
...
HXLINE(  33)		return ::haxe::Utf8_obj::charCodeAt(s,index);
            	}
...
HXLINE(  44)		return ::haxe::Utf8_obj::charCodeAt(s,index);
            	}
...
HXLINE(  73)		if ((delimiter.length == (int)0)) {
...
HXLINE(  73)			return s.split(delimiter);
            		}
...
HXLINE( 113)		return  ::lime::text::unifill::CodePointIter_obj::__alloc( HX_CTX ,s);
            	}
...
HXLINE(  19)		aiter_i = (int)0;
HXLINE( 120)		aiter_string = a;
...
HXLINE(  19)		biter_i = (int)0;
HXLINE( 121)		biter_string = b;
...
HXLINE( 141)		 ::haxe::io::BytesBuffer buf =  ::haxe::io::BytesBuffer_obj::__alloc( HX_CTX );
HXDLIN( 141)		{
HXLINE( 141)			 ::Dynamic c = codePoints->__Field(HX_("iterator",ee,49,9a,93),hx::paccDynamic)();
HXDLIN( 141)			while(( (bool)(c->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)()) )){
HXLINE( 141)				int c1 = ( (int)(c->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)()) );
HXDLIN( 141)				if ((c1 <= (int)127)) {
HXLINE( 141)					buf->b->push(c1);
            				}
            				else {
HXLINE( 141)					if ((c1 <= (int)2047)) {
HXLINE( 141)						::Array< unsigned char > buf1 = buf->b;
...
HXLINE( 141)						if ((c1 <= (int)65535)) {
HXLINE( 141)							::Array< unsigned char > buf3 = buf->b;
...
HXLINE( 141)							if ((c1 <= (int)1114111)) {
HXLINE( 141)								::Array< unsigned char > buf6 = buf->b;
...
HXLINE( 141)								HX_STACK_DO_THROW( ::lime::text::unifill::InvalidCodePoint_obj::__alloc( HX_CTX ,c1));
            							}
            						}
            					}
            				}
...
HXLINE( 148)			if (hx::IsNull( sb->charBuf )) {
HXLINE( 148)				sb->charBuf = ::Array_obj< char >::__new();
            			}
HXDLIN( 148)			sb->charBuf->push(c1);
            		}
            		else {
HXLINE( 148)			if ((c1 <= (int)2047)) {
HXLINE( 148)				{
HXLINE( 148)					if (hx::IsNull( sb->charBuf )) {
HXLINE( 148)						sb->charBuf = ::Array_obj< char >::__new();
            					}
...
HXLINE( 148)						HX_STACK_DO_THROW( ::lime::text::unifill::InvalidCodePoint_obj::__alloc( HX_CTX ,c1));
            					}
            				}
            			}
            		}
