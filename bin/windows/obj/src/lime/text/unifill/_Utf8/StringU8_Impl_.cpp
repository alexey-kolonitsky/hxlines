...
HXLINE( 260)		::String this1 = b->toString();
...
HXLINE( 264)		::String this1 = b->toString();
...
HXLINE( 270)		return this1.cca(index);
            	}
...
HXLINE( 274)		::String this2 = this1.substr(index,len);
...
HXLINE( 282)		return ::haxe::io::Bytes_obj::ofString(this1);
            	}
...
HXLINE( 290)		return this1.length;
            	}
