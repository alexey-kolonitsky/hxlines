...
HXLINE(  15)		 ::haxe::io::BytesBuffer buf =  ::haxe::io::BytesBuffer_obj::__alloc( HX_CTX );
HXDLIN(  15)		if ((a <= (int)127)) {
HXLINE(  15)			buf->b->push(a);
            		}
            		else {
HXLINE(  15)			if ((a <= (int)2047)) {
HXLINE(  15)				::Array< unsigned char > buf1 = buf->b;
...
HXLINE(  15)				if ((a <= (int)65535)) {
HXLINE(  15)					::Array< unsigned char > buf3 = buf->b;
...
HXLINE(  15)					if ((a <= (int)1114111)) {
HXLINE(  15)						::Array< unsigned char > buf6 = buf->b;
...
HXLINE(  15)						HX_STACK_DO_THROW( ::lime::text::unifill::InvalidCodePoint_obj::__alloc( HX_CTX ,a));
            					}
            				}
            			}
            		}
...
HXLINE(  19)		 ::haxe::io::BytesBuffer buf =  ::haxe::io::BytesBuffer_obj::__alloc( HX_CTX );
HXDLIN(  19)		if ((b <= (int)127)) {
HXLINE(  19)			buf->b->push(b);
            		}
            		else {
HXLINE(  19)			if ((b <= (int)2047)) {
HXLINE(  19)				::Array< unsigned char > buf1 = buf->b;
...
HXLINE(  19)				if ((b <= (int)65535)) {
HXLINE(  19)					::Array< unsigned char > buf3 = buf->b;
...
HXLINE(  19)					if ((b <= (int)1114111)) {
HXLINE(  19)						::Array< unsigned char > buf6 = buf->b;
...
HXLINE(  19)						HX_STACK_DO_THROW( ::lime::text::unifill::InvalidCodePoint_obj::__alloc( HX_CTX ,b));
            					}
            				}
            			}
            		}
...
HXLINE(  23)			bool _hx_tmp4;
HXDLIN(  23)			if (((int)56320 <= code)) {
HXLINE(  23)				_hx_tmp4 = (code <= (int)57343);
            			}
            			else {
HXLINE(  23)				_hx_tmp4 = false;
            			}
...
HXLINE(  23)			HX_STACK_DO_THROW( ::lime::text::unifill::InvalidCodePoint_obj::__alloc( HX_CTX ,code));
            		}
...
HXLINE(  31)				_hx_tmp3 = (code <= (int)56319);
            			}
            			else {
...
HXLINE(  31)				_hx_tmp4 = (code <= (int)57343);
            			}
            			else {
HXLINE(  31)				_hx_tmp4 = false;
            			}
...
HXLINE(  31)			HX_STACK_DO_THROW( ::lime::text::unifill::InvalidCodePoint_obj::__alloc( HX_CTX ,code));
            		}
...
HXLINE(  46)		 ::haxe::io::BytesBuffer buf =  ::haxe::io::BytesBuffer_obj::__alloc( HX_CTX );
HXDLIN(  46)		if ((this1 <= (int)127)) {
HXLINE(  46)			buf->b->push(this1);
            		}
            		else {
HXLINE(  46)			if ((this1 <= (int)2047)) {
HXLINE(  46)				::Array< unsigned char > buf1 = buf->b;
...
HXLINE(  46)				if ((this1 <= (int)65535)) {
HXLINE(  46)					::Array< unsigned char > buf3 = buf->b;
...
HXLINE(  46)					if ((this1 <= (int)1114111)) {
HXLINE(  46)						::Array< unsigned char > buf6 = buf->b;
...
HXLINE(  46)						HX_STACK_DO_THROW( ::lime::text::unifill::InvalidCodePoint_obj::__alloc( HX_CTX ,this1));
            					}
            				}
            			}
            		}
