...
HXLINE( 137)			_hx_tmp = hx::IsNull( array );
            		}
            		else {
...
HXLINE( 213)		switch((int)(type)){
            			case (int)1: {
HXLINE( 212)				return (int)1;
            			}
            			break;
            			case (int)2: {
HXLINE( 212)				return (int)2;
            			}
            			break;
            			case (int)3: {
HXLINE( 212)				return (int)4;
            			}
            			break;
            			case (int)4: {
HXLINE( 212)				return (int)1;
...
HXLINE( 271)		return (elemCount * this->bytesPerElement);
            	}
