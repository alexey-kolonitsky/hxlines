...
HXLINE(  96)		 ::Dynamic end1 = end;
HXDLIN(  96)		if (hx::IsNull( end1 )) {
HXLINE(  96)			end1 = this1->length;
            		}
...
HXLINE(  96)						newByteLength = (bufferByteLength - in_byteOffset);
...
HXDLIN(  96)					if (hx::IsNull( len )) {
HXLINE(  96)						newByteLength1 = (bufferByteLength1 - in_byteOffset1);
...
HXDLIN(  96)					if (hx::IsNull( len )) {
HXLINE(  96)						newByteLength2 = (bufferByteLength2 - in_byteOffset2);
...
HXDLIN(  96)					if (hx::IsNull( len )) {
HXLINE(  96)						newByteLength3 = (bufferByteLength3 - in_byteOffset3);
...
HXDLIN(  96)					if (hx::IsNull( len )) {
HXLINE(  96)						newByteLength4 = (bufferByteLength4 - in_byteOffset4);
...
HXDLIN(  96)					if (hx::IsNull( len )) {
HXLINE(  96)						newByteLength5 = (bufferByteLength5 - in_byteOffset5);
...
HXDLIN(  96)					if (hx::IsNull( len )) {
HXLINE(  96)						newByteLength6 = (bufferByteLength6 - in_byteOffset6);
...
HXDLIN(  96)					if (hx::IsNull( len )) {
HXLINE(  96)						newByteLength7 = (bufferByteLength7 - in_byteOffset7);
...
HXDLIN(  96)					if (hx::IsNull( len )) {
HXLINE(  96)						newByteLength8 = (bufferByteLength8 - in_byteOffset8);
...
HXLINE( 101)				newByteLength = (bufferByteLength - in_byteOffset);
