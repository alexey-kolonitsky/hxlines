...
HXLINE(  18)		 ::haxe::io::Bytes this1 =  ::haxe::io::Bytes_obj::__alloc( HX_CTX ,length,bytesData);
...
HXLINE(  39)		return _hx_array_unsafe_get(b,pos);
            	}
...
HXLINE(  72)		return ::lime::app::Future_obj::withValue(::lime::utils::_Bytes::Bytes_Impl__obj::fromBytes(bytes));
            	}
