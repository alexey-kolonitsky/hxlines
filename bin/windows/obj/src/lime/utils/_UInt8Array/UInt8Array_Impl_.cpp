...
HXLINE(  99)			 ::lime::utils::ArrayBufferView _this =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,(int)0,(int)4);
...
HXLINE(  99)			HX_STACK_DO_THROW(HX_("Invalid constructor arguments for UInt8Array",6b,44,d5,85));
            		}
...
HXLINE( 108)		if (hx::IsNotNull( this1 )) {
HXLINE( 108)			return ((((HX_("UInt8Array [byteLength:",d6,2f,a0,d4) + this1->byteLength) + HX_(", length:",a0,04,67,ef)) + this1->length) + HX_("]",5d,00,00,00));
            		}
            		else {
...
HXLINE( 110)		return this1->length;
            	}
...
HXLINE(  64)		BYTES_PER_ELEMENT = (int)1;
            	}
}
