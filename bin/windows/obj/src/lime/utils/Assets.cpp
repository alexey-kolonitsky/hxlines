...
HXLINE( 191)		return ( ( ::lime::media::AudioBuffer)(::lime::utils::Assets_obj::getAsset(id,HX_("SOUND",af,c4,ba,fe),useCache)) );
            	}
...
HXLINE( 204)		return ( ( ::haxe::io::Bytes)(::lime::utils::Assets_obj::getAsset(id,HX_("BINARY",01,68,8e,9f),false)) );
            	}
...
HXLINE( 217)		return ::lime::utils::Assets_obj::getAsset(id,HX_("FONT",cf,25,81,2e),useCache);
            	}
...
HXLINE( 231)		return ::lime::utils::Assets_obj::getAsset(id,HX_("IMAGE",3b,57,57,3b),useCache);
            	}
...
HXLINE( 294)		return ::lime::utils::Assets_obj::getAsset(id,HX_("TEXT",ad,94,ba,37),false);
            	}
...
HXLINE( 338)		return hx::IsNotNull( buffer );
            	}
...
HXLINE( 347)		if (hx::IsNotNull( image )) {
HXLINE( 347)			return hx::IsNotNull( image->buffer );
            		}
            		else {
...
HXLINE( 466)		return ::lime::utils::Assets_obj::loadAsset(id,HX_("SOUND",af,c4,ba,fe),useCache);
            	}
...
HXLINE( 473)		return ::lime::utils::Assets_obj::loadAsset(id,HX_("BINARY",01,68,8e,9f),false);
            	}
...
HXLINE( 480)		return ::lime::utils::Assets_obj::loadAsset(id,HX_("FONT",cf,25,81,2e),useCache);
            	}
...
HXLINE( 487)		return ::lime::utils::Assets_obj::loadAsset(id,HX_("IMAGE",3b,57,57,3b),useCache);
            	}
...
HXLINE( 558)		return ::lime::utils::Assets_obj::loadAsset(id,HX_("TEXT",ad,94,ba,37),false);
            	}
...
HXLINE(  47)		cache =  ::lime::utils::AssetCache_obj::__alloc( HX_CTX );
            	}
{
            	HX_GC_STACKFRAME(&_hx_pos_df5754140b017d9f_48_boot)
HXLINE(  48)		onChange =  ::lime::app::_Event_Void_Void_obj::__alloc( HX_CTX );
            	}
{
            	HX_GC_STACKFRAME(&_hx_pos_df5754140b017d9f_51_boot)
HXLINE(  51)		libraries =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
            	}
{
            	HX_GC_STACKFRAME(&_hx_pos_df5754140b017d9f_52_boot)
HXLINE(  52)		libraryPaths =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
            	}
}
