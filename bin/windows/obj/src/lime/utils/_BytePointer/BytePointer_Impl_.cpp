...
HXLINE(  16)		 ::lime::utils::BytePointerData this1 =  ::lime::utils::BytePointerData_obj::__alloc( HX_CTX ,bytes,offset);
...
HXLINE(  57)		if (hx::IsNotNull( this1->bytes )) {
HXLINE(  57)			return this1->bytes->b->__get((index + this1->offset));
            		}
            		else {
...
HXLINE(  98)		return  ::lime::utils::BytePointerData_obj::__alloc( HX_CTX ,bytes,(int)0);
            	}
...
HXLINE( 105)		if (hx::IsNull( bytesData )) {
HXLINE( 105)			return  ::lime::utils::BytePointerData_obj::__alloc( HX_CTX ,null(),(int)0);
            		}
            		else {
...
HXLINE( 113)		return  ::lime::utils::BytePointerData_obj::__alloc( HX_CTX ,::lime::utils::_Bytes::Bytes_Impl__obj::fromFile(path),(int)0);
            	}
...
HXLINE( 120)		return  ::lime::utils::BytePointerData_obj::__alloc( HX_CTX ,bytes,(int)0);
            	}
...
HXLINE( 130)		 ::haxe::io::Bytes buffer = bytePointer->bytes;
...
HXLINE( 130)			 ::lime::utils::ArrayBufferView _this =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,(int)0,(int)4);
...
HXLINE( 130)			HX_STACK_DO_THROW(HX_("Invalid constructor arguments for UInt8Array",6b,44,d5,85));
            		}
