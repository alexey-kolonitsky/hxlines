...
HXLINE(  42)		return  ::lime::math::Rectangle_obj::__alloc( HX_CTX ,this->x,this->y,this->width,this->height);
            	}
...
HXLINE(  49)			_hx_tmp = (x < this->get_right());
            		}
            		else {
HXLINE(  49)			_hx_tmp = false;
            		}
HXDLIN(  49)		if (_hx_tmp) {
HXLINE(  49)			return (y < this->get_bottom());
            		}
            		else {
...
HXLINE( 312)		Float _hx_tmp = (this->x + this->width);
...
HXLINE( 315)		 ::lime::math::Rectangle _hx_tmp = hx::ObjectPtr<OBJ_>(this);
...
HXLINE( 318)		return  ::lime::math::Vector2_obj::__alloc( HX_CTX ,this->width,this->height);
            	}
...
HXLINE( 321)		 ::lime::math::Rectangle _hx_tmp = hx::ObjectPtr<OBJ_>(this);
...
HXLINE( 322)		return  ::lime::math::Vector2_obj::__alloc( HX_CTX ,this->x,this->y);
            	}
