...
HXLINE(  32)		Float _hx_tmp = (v->x + this->x);
...
HXLINE(  39)		return  ::lime::math::Vector2_obj::__alloc( HX_CTX ,this->x,this->y);
            	}
...
HXLINE(  55)			_hx_tmp = (toCompare->x == this->x);
            		}
            		else {
HXLINE(  55)			_hx_tmp = false;
            		}
HXDLIN(  55)		if (_hx_tmp) {
HXLINE(  55)			return (toCompare->y == this->y);
            		}
            		else {
...
HXLINE(  69)			_hx_tmp = (this->y == (int)0);
            		}
            		else {
...
HXLINE( 108)		Float _hx_tmp = (this->x - v->x);
...
HXLINE( 133)		Float _hx_tmp = (this->x * this->x);
...
HXLINE(  94)		Float _hx_tmp = (len * ::Math_obj::cos(angle));
