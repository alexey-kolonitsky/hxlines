...
HX_LOCAL_STACK_FRAME(_hx_pos_8aefb717ac50a4ec_38_run,"cpp.vm.Gc","run",0x3d3e0d65,"cpp.vm.Gc.run","C:\\alexey\\apps\\haxe\\std/cpp/vm/Gc.hx",38,0x95985293)
namespace cpp{
namespace vm{
...
void Gc_obj::run(bool major){
            	HX_STACKFRAME(&_hx_pos_8aefb717ac50a4ec_38_run)
