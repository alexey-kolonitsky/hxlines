...
HX_DEFINE_STACK_FRAME(_hx_pos_9a4c65572696d03c_255_new,"_List.ListNode","new",0x20597943,"_List.ListNode.new","C:\\alexey\\apps\\haxe\\std/List.hx",255,0x44b3a723)
namespace _List{

void ListNode_obj::__construct( ::Dynamic item, ::_List::ListNode next){
            	HX_STACKFRAME(&_hx_pos_9a4c65572696d03c_255_new)
