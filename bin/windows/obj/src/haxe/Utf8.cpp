...
HX_DEFINE_STACK_FRAME(_hx_pos_11359c19acfa4b7f_31_new,"haxe.Utf8","new",0x67cc940b,"haxe.Utf8.new","C:\\alexey\\apps\\haxe\\std/cpp/_std/haxe/Utf8.hx",31,0x56fc50a6)
HX_LOCAL_STACK_FRAME(_hx_pos_11359c19acfa4b7f_38_addChar,"haxe.Utf8","addChar",0x9a1816c2,"haxe.Utf8.addChar","C:\\alexey\\apps\\haxe\\std/cpp/_std/haxe/Utf8.hx",38,0x56fc50a6)
HX_LOCAL_STACK_FRAME(_hx_pos_11359c19acfa4b7f_42_toString,"haxe.Utf8","toString",0xb459e121,"haxe.Utf8.toString","C:\\alexey\\apps\\haxe\\std/cpp/_std/haxe/Utf8.hx",42,0x56fc50a6)
HX_LOCAL_STACK_FRAME(_hx_pos_11359c19acfa4b7f_66_charCodeAt,"haxe.Utf8","charCodeAt",0xce7cbeab,"haxe.Utf8.charCodeAt","C:\\alexey\\apps\\haxe\\std/cpp/_std/haxe/Utf8.hx",66,0x56fc50a6)
HX_LOCAL_STACK_FRAME(_hx_pos_11359c19acfa4b7f_74_length,"haxe.Utf8","length",0x88322e1b,"haxe.Utf8.length","C:\\alexey\\apps\\haxe\\std/cpp/_std/haxe/Utf8.hx",74,0x56fc50a6)
HX_LOCAL_STACK_FRAME(_hx_pos_11359c19acfa4b7f_82_sub,"haxe.Utf8","sub",0x67d06d2b,"haxe.Utf8.sub","C:\\alexey\\apps\\haxe\\std/cpp/_std/haxe/Utf8.hx",82,0x56fc50a6)
namespace haxe{

void Utf8_obj::__construct( ::Dynamic size){
            	HX_STACKFRAME(&_hx_pos_11359c19acfa4b7f_31_new)
...
void Utf8_obj::addChar(int c){
            	HX_STACKFRAME(&_hx_pos_11359c19acfa4b7f_38_addChar)
...
::String Utf8_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_11359c19acfa4b7f_42_toString)
HXLINE(  42)		return ::__hxcpp_char_array_to_utf8_string(this->__s);
            	}
...
int Utf8_obj::charCodeAt(::String s,int index){
            	HX_STACKFRAME(&_hx_pos_11359c19acfa4b7f_66_charCodeAt)
...
int Utf8_obj::length(::String s){
            	HX_STACKFRAME(&_hx_pos_11359c19acfa4b7f_74_length)
...
::String Utf8_obj::sub(::String s,int pos,int len){
            	HX_STACKFRAME(&_hx_pos_11359c19acfa4b7f_82_sub)
