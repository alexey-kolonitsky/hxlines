...
HX_DEFINE_STACK_FRAME(_hx_pos_340ec1518bf395eb_76_new,"haxe.io.Path","new",0x1b96d677,"haxe.io.Path.new","C:\\alexey\\apps\\haxe\\std/haxe/io/Path.hx",76,0xe878e75c)
HX_LOCAL_STACK_FRAME(_hx_pos_340ec1518bf395eb_115_toString,"haxe.io.Path","toString",0xc0ab5735,"haxe.io.Path.toString","C:\\alexey\\apps\\haxe\\std/haxe/io/Path.hx",115,0xe878e75c)
HX_LOCAL_STACK_FRAME(_hx_pos_340ec1518bf395eb_134_withoutDirectory,"haxe.io.Path","withoutDirectory",0xdf35ce8e,"haxe.io.Path.withoutDirectory","C:\\alexey\\apps\\haxe\\std/haxe/io/Path.hx",134,0xe878e75c)
HX_LOCAL_STACK_FRAME(_hx_pos_340ec1518bf395eb_147_directory,"haxe.io.Path","directory",0xbcfe23c4,"haxe.io.Path.directory","C:\\alexey\\apps\\haxe\\std/haxe/io/Path.hx",147,0xe878e75c)
HX_LOCAL_STACK_FRAME(_hx_pos_340ec1518bf395eb_190_join,"haxe.io.Path","join",0x05c781f3,"haxe.io.Path.join","C:\\alexey\\apps\\haxe\\std/haxe/io/Path.hx",190,0xe878e75c)
HX_LOCAL_STACK_FRAME(_hx_pos_340ec1518bf395eb_189_join,"haxe.io.Path","join",0x05c781f3,"haxe.io.Path.join","C:\\alexey\\apps\\haxe\\std/haxe/io/Path.hx",189,0xe878e75c)
HX_LOCAL_STACK_FRAME(_hx_pos_340ec1518bf395eb_210_normalize,"haxe.io.Path","normalize",0x585a68e4,"haxe.io.Path.normalize","C:\\alexey\\apps\\haxe\\std/haxe/io/Path.hx",210,0xe878e75c)
...
HX_LOCAL_STACK_FRAME(_hx_pos_340ec1518bf395eb_262_addTrailingSlash,"haxe.io.Path","addTrailingSlash",0x8b4f8e69,"haxe.io.Path.addTrailingSlash","C:\\alexey\\apps\\haxe\\std/haxe/io/Path.hx",262,0xe878e75c)
HX_LOCAL_STACK_FRAME(_hx_pos_340ec1518bf395eb_287_removeTrailingSlashes,"haxe.io.Path","removeTrailingSlashes",0x2dc73462,"haxe.io.Path.removeTrailingSlashes","C:\\alexey\\apps\\haxe\\std/haxe/io/Path.hx",287,0xe878e75c)
HX_LOCAL_STACK_FRAME(_hx_pos_340ec1518bf395eb_301_isAbsolute,"haxe.io.Path","isAbsolute",0xb396db4a,"haxe.io.Path.isAbsolute","C:\\alexey\\apps\\haxe\\std/haxe/io/Path.hx",301,0xe878e75c)
namespace haxe{
namespace io{

void Path_obj::__construct(::String path){
            	HX_STACKFRAME(&_hx_pos_340ec1518bf395eb_76_new)
...
::String Path_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_340ec1518bf395eb_115_toString)
HXLINE( 115)		::String _hx_tmp;
HXDLIN( 115)		if (hx::IsNull( this->dir )) {
HXLINE( 115)			_hx_tmp = HX_("",00,00,00,00);
            		}
            		else {
HXLINE( 115)			::String _hx_tmp1;
HXDLIN( 115)			if (this->backslash) {
HXLINE( 115)				_hx_tmp1 = HX_("\\",5c,00,00,00);
            			}
            			else {
HXLINE( 115)				_hx_tmp1 = HX_("/",2f,00,00,00);
            			}
HXDLIN( 115)			_hx_tmp = (this->dir + _hx_tmp1);
            		}
HXDLIN( 115)		::String _hx_tmp2;
HXDLIN( 115)		if (hx::IsNull( this->ext )) {
HXLINE( 115)			_hx_tmp2 = HX_("",00,00,00,00);
            		}
            		else {
HXLINE( 115)			_hx_tmp2 = (HX_(".",2e,00,00,00) + this->ext);
            		}
...
::String Path_obj::withoutDirectory(::String path){
            	HX_GC_STACKFRAME(&_hx_pos_340ec1518bf395eb_134_withoutDirectory)
...
::String Path_obj::directory(::String path){
            	HX_GC_STACKFRAME(&_hx_pos_340ec1518bf395eb_147_directory)
...
::String Path_obj::join(::Array< ::String > paths){
            		...
            		bool _hx_run(::String s){
            			HX_STACKFRAME(&_hx_pos_340ec1518bf395eb_190_join)
...
HXDLIN( 190)			return false;
            	...
            	HX_STACKFRAME(&_hx_pos_340ec1518bf395eb_189_join)
...
::String Path_obj::normalize(::String path){
            	HX_GC_STACKFRAME(&_hx_pos_340ec1518bf395eb_210_normalize)
...
::String Path_obj::addTrailingSlash(::String path){
            	HX_STACKFRAME(&_hx_pos_340ec1518bf395eb_262_addTrailingSlash)
...
::String Path_obj::removeTrailingSlashes(::String path){
            	HX_STACKFRAME(&_hx_pos_340ec1518bf395eb_287_removeTrailingSlashes)
...
bool Path_obj::isAbsolute(::String path){
            	HX_STACKFRAME(&_hx_pos_340ec1518bf395eb_301_isAbsolute)
