...
HXLINE(  59)		return this->b->__get(pos);
            	}
...
HXLINE( 136)		::__hxcpp_memory_memset(this->b,pos,len,value);
            	}
...
HXLINE( 205)		return this->b->memcmp(other->b);
            	}
...
HXLINE( 308)		int _hx_tmp = this->b->__get(pos);
...
HXLINE( 337)		int _hx_tmp = this->b->__get(pos);
...
HXLINE( 430)		return this->getString(pos,len);
            	}
...
HXLINE( 450)		return this->getString((int)0,this->length);
            	}
...
HXLINE( 571)		return  ::haxe::io::Bytes_obj::__alloc( HX_CTX ,b->length,b);
            	}
...
HXLINE( 587)		return _hx_array_unsafe_get(b,pos);
            	}
