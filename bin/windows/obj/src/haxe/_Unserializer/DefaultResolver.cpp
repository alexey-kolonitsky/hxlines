...
HX_DEFINE_STACK_FRAME(_hx_pos_acc4b6950b8aa529_476_new,"haxe._Unserializer.DefaultResolver","new",0xe2809ead,"haxe._Unserializer.DefaultResolver.new","C:\\alexey\\apps\\haxe\\std/haxe/Unserializer.hx",476,0xeda88a27)
HX_LOCAL_STACK_FRAME(_hx_pos_acc4b6950b8aa529_477_resolveClass,"haxe._Unserializer.DefaultResolver","resolveClass",0xbc0d3dbf,"haxe._Unserializer.DefaultResolver.resolveClass","C:\\alexey\\apps\\haxe\\std/haxe/Unserializer.hx",477,0xeda88a27)
HX_LOCAL_STACK_FRAME(_hx_pos_acc4b6950b8aa529_478_resolveEnum,"haxe._Unserializer.DefaultResolver","resolveEnum",0x8198f35a,"haxe._Unserializer.DefaultResolver.resolveEnum","C:\\alexey\\apps\\haxe\\std/haxe/Unserializer.hx",478,0xeda88a27)
namespace haxe{
namespace _Unserializer{

void DefaultResolver_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_acc4b6950b8aa529_476_new)
            	}
...
hx::Class DefaultResolver_obj::resolveClass(::String name){
            	HX_STACKFRAME(&_hx_pos_acc4b6950b8aa529_477_resolveClass)
HXLINE( 477)		return ::Type_obj::resolveClass(name);
            	}
...
hx::Class DefaultResolver_obj::resolveEnum(::String name){
            	HX_STACKFRAME(&_hx_pos_acc4b6950b8aa529_478_resolveEnum)
HXLINE( 478)		return ::Type_obj::resolveEnum(name);
            	}
