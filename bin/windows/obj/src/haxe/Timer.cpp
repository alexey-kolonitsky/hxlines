...
HXLINE( 308)		if ((inTime >= this->mFireAt)) {
...
HXLINE( 255)		return ::lime::_hx_system::System_obj::getTimer();
            	}
...
HXLINE( 279)		return ((Float)::lime::_hx_system::System_obj::getTimer() / (Float)(int)1000);
            	}
...
HXLINE( 220)		sRunningTimers = ::Array_obj< ::Dynamic>::__new(0);
            	}
}
