...
HX_LOCAL_STACK_FRAME(_hx_pos_85109056d237965e_77___default_trace,"haxe.Log","__default_trace",0xe2f5e5d5,"haxe.Log.__default_trace","C:\\alexey\\apps\\haxe\\std/haxe/Log.hx",77,0x14102e86)
namespace haxe{
...
void _hx_run( ::Dynamic v, ::Dynamic infos){
            	HX_STACKFRAME(&_hx_pos_85109056d237965e_77___default_trace)
HXLINE(  77)		bool _hx_tmp;
HXDLIN(  77)		if (hx::IsNotNull( infos )) {
HXLINE(  77)			_hx_tmp = hx::IsNotNull( ( (::cpp::VirtualArray)(infos->__Field(HX_("customParams",d7,51,18,ed),hx::paccDynamic)) ) );
            		}
            		else {
