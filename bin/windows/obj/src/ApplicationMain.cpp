...
HXLINE( 227)		 ::Dynamic init = hx::ClassOf< ::lime::app::Application >();
            	}


void ApplicationMain_obj::main(){
            	HX_STACKFRAME(&_hx_pos_6fcf922b66429816_21_main)
HXLINE(  23)		::String projectName = HX_("lines",ff,dd,01,75);
HXLINE(  25)		 ::Dynamic config =  ::Dynamic(hx::Anon_obj::Create(9)
            			->setFixed(0,HX_("company",3d,15,69,83),HX_("My Company",89,30,89,01))
            			->setFixed(1,HX_("build",2e,db,ea,ba),HX_("77",20,30,00,00))
            			->setFixed(2,HX_("windows",83,de,74,e8),::Array_obj< ::Dynamic>::__new(1)->init(0, ::Dynamic(hx::Anon_obj::Create(21)
            				...
            				->setFixed(3,HX_("width",06,b6,62,ca),(int)500)
            				...
            				->setFixed(8,HX_("height",e7,07,4c,02),(int)500)
            				->setFixed(9,HX_("title",98,15,3b,10),HX_("Lines",df,4d,2f,08))
            				->setFixed(10,HX_("alwaysOnTop",67,4d,53,16),false)
            				->setFixed(11,HX_("borderless",45,46,71,17),false)
            				->setFixed(12,HX_("background",ee,93,1d,26),(int)3355443)
            			...
            			->setFixed(5,HX_("packageName",f1,04,ad,04),HX_("com.mycompany.myproject",e3,c8,d6,26))
            			->setFixed(6,HX_("file",7c,ce,bb,43),HX_("lines",ff,dd,01,75))
            			->setFixed(7,HX_("name",4b,72,ff,48),HX_("Lines",df,4d,2f,08))
